...
export const WebCommand = cmd({
  ...
  describe: "start kilo server and open web interface", // ggai_change
  handler: async (args) => {
    if (!Flag.GGAI_SERVER_PASSWORD) {
      UI.println(UI.Style.TEXT_WARNING_BOLD + "!  " + "GGAI_SERVER_PASSWORD is not set; server is unsecured.")
    }
