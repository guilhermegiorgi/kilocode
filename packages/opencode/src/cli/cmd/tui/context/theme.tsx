...
import kilo from "./theme/kilo.json" with { type: "json" } // ggai_change
...
export const { use: useTheme, provider: ThemeProvider } = createSimpleContext({
  ...
  init: (props: { mode: "dark" | "light" }) => {
    ...
    const [store, setStore] = createStore({
      ...
      active: (config.theme ?? kv.get("theme", "kilo")) as string, // ggai_change
      ready: false,
    })
    ...
    function init() {
      ...
      getCustomThemes()
        ...
        .catch(() => {
          setStore("active", "kilo") // ggai_change
        })
        .finally(() => {
