...
1. **On startup**, if the user is authenticated with Kilo Gateway, the CLI fetches notifications from `https://api.gg.ai/api/users/notifications`
...
Action: Learn More -> https://docs.gg.ai/skills
```
