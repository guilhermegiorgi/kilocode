...
import { KilocodeConfigInjector } from "../../src/ggai/config-injector"
...
describe("KilocodeConfigInjector", () => {
  ...
  - slug: translate
    ...
    // ggai_change start - Rules migration tests
  ...
  - slug: translate
    ...
    // ggai_change start - Ignore migration tests
