...
**Priority:** P2
**Status:** ❌ Not started
**Issue:** [#6230](https://github.com/genesisgrid/kilocode/issues/6230)

## Problem

The old GG.AI extension had an "Architect mode" that would write the resulting plan as a `.md` file into a `/plans` directory in the project root. Users adopted this workflow and now miss it.
