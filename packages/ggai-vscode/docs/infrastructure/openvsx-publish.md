...
**Priority:** P3
**Status:** ❌ Not started
**Issue:** [#6080](https://github.com/genesisgrid/kilocode/issues/6080)

## Problem

The extension is currently only published to the VS Code Marketplace. OpenVSX is the alternative registry used by VS Code forks (VS Codium, Eclipse Theia, Gitpod, etc.). Users on these platforms cannot install GG.AI from their built-in extension manager.

## Remaining Work

- Create an OpenVSX publisher account for GG.AI at [open-vsx.org](https://open-vsx.org)
