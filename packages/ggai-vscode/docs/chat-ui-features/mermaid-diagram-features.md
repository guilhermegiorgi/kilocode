...
These components exist in the [kilocode-legacy](https://github.com/genesisgrid/kilocode-legacy) repo, not in this extension:
...
- Kilo CLI UI doesn't appear to ship an equivalent Mermaid renderer/fixer (only a Mermaid file icon is present in [`packages/ui/src/components/file-icons/types.ts`](https://github.com/genesisgrid/kilocode/blob/main/packages/ui/src/components/file-icons/types.ts:1)).
