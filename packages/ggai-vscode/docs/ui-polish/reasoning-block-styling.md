...
**Priority:** P2
**Status:** ❌ Not started
**Issue:** [#6254](https://github.com/genesisgrid/kilocode/issues/6254)
...
- Collapse reasoning blocks by default with an expand toggle, since they can be very long (see PR [#6217](https://github.com/genesisgrid/kilocode/pull/6217) for prior work)
