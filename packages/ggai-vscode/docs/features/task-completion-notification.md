...
**Priority:** P2
**Status:** ❌ Not started
**Issue:** [#6084](https://github.com/genesisgrid/kilocode/issues/6084)
...
- When a session transitions to "complete" or "awaiting input" state, show a VS Code notification (toast) if the GG.AI window is not currently focused
...
- Notifications should include a "Show" button that focuses the GG.AI webview panel
