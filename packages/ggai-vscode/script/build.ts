...
const version = process.env.GGAI_VERSION ? process.env.GGAI_VERSION : packageJson.version
...
const targets = [
  { target: "linux-x64", cliDir: "@kilocode/cli-linux-x64", binary: "ggai" },
  { target: "linux-arm64", cliDir: "@kilocode/cli-linux-arm64", binary: "ggai" },
  { target: "alpine-x64", cliDir: "@kilocode/cli-linux-x64-musl", binary: "ggai" },
  { target: "alpine-arm64", cliDir: "@kilocode/cli-linux-arm64-musl", binary: "ggai" },
  { target: "darwin-x64", cliDir: "@kilocode/cli-darwin-x64", binary: "ggai" },
  { target: "darwin-arm64", cliDir: "@kilocode/cli-darwin-arm64", binary: "ggai" },
  { target: "win32-x64", cliDir: "@kilocode/cli-windows-x64", binary: "ggai.exe" },
]
