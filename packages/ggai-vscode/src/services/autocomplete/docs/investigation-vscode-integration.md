...
```jsonc
{
  "autocomplete": {
    "statusBar": {
      ...
      "tooltip": {
        "basic": "GG.AI Autocomplete",
        "disabled": "GG.AI Autocomplete (disabled)",
        "noCredits": "...",
        "noUsableProvider": "...",
    ...
    "toggleMessage": "GG.AI Autocomplete {{status}}",
    "progress": {
      "title": "GG.AI",
    ...
    "input": {
      "title": "GG.AI: Quick Task",
      "placeholder": "e.g., 'refactor this function to be more efficient'",
    },
    "commands": {
      "generateSuggestions": "GG.AI: Generate Suggested Edits",
    ...
    "codeAction": {
      "title": "GG.AI: Suggested Edits",
    },
    "chatParticipant": {
      "fullName": "GG.AI Agent",
      "name": "Agent",
      "description": "I can help you with quick tasks and suggested edits.",
    },
    "incompatibilityExtensionPopup": {
      "message": "The GG.AI Autocomplete is being blocked by a conflict with GitHub Copilot. To fix this, you must disable Copilot's inline suggestions.",
