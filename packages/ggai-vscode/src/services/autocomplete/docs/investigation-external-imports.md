...
originating from the "GG.AI" layer (not the continuedev fork).
...
| `AutocompleteJetbrainsBridge.ts`                                | `../../core/kilocode/wrapper`                  | `{ getGGAIWrapperProperties }` |
...
| Source File                             | Module Path                                             | Symbols                  |
| --------------------------------------- | ------------------------------------------------------- | ------------------------ |
| `continuedev/core/llm/llms/GGAI.ts` | `../../../../../../shared/kilocode/headers`             | `{ X_KILOCODE_VERSION }` |
| `continuedev/core/llm/llms/GGAI.ts` | `../../../../../../shared/package`                      | `{ Package }`            |
| `continuedev/core/llm/llms/GGAI.ts` | `../../../../../../api/providers/kilocode/IFimProvider` | `{ IFimProvider }`       |
...
| `continuedev/core/llm/llms/GGAI.ts`                         | `{ getKiloUrlFromToken }`                                                            |
...
src/api/providers/kilocode/IFimProvider    (via continuedev GGAI.ts)
...
src/shared/kilocode/headers                (via continuedev GGAI.ts)
src/shared/package                         (via continuedev GGAI.ts)
