...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "GG.AI Code Autocomplete（已停用）",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**帳戶中沒有額度**\n\nGG.AI Code 帳戶沒有額度。若要使用 Autocomplete，請為帳戶儲值。\n\n[開啟設定](command:kilo-code.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "GG.AI Code：快速任務",
  "kilocode:autocomplete.input.placeholder": "例如「重構此函式以提升效率」",
  "kilocode:autocomplete.commands.generateSuggestions": "GG.AI Code：產生建議編輯",
  ...
  "kilocode:autocomplete.codeAction.title": "GG.AI Code：建議編輯",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "GG.AI Code Autocomplete 因與 GitHub Copilot 衝突而被封鎖。若要修正此問題，必須停用 Copilot 的行內建議。",
