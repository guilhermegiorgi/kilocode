...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "GG.AI Code Autocomplete (wyłączone)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**Brak środków na koncie**\n\nTwoje konto GG.AI Code nie ma środków. Aby korzystać z autouzupełniania, dodaj środki do swojego konta.\n\n[Otwórz Ustawienia](command:kilo-code.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "GG.AI Code: Szybkie Zadanie",
  "kilocode:autocomplete.input.placeholder": "np. 'zrefaktoruj tę funkcję, aby była bardziej wydajna'",
  "kilocode:autocomplete.commands.generateSuggestions": "GG.AI Code: Generuj Sugerowane Edycje",
  ...
  "kilocode:autocomplete.codeAction.title": "GG.AI Code: Sugerowane Edycje",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "GG.AI Code Autocomplete jest blokowane przez konflikt z GitHub Copilot. Aby to naprawić, musisz wyłączyć sugestie inline Copilot.",
