...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "GG.AI Code Autocomplete (zakázané)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**Na tvojom účte nie sú žiadne kredity**\n\nTvoj účet GG.AI Code nemá žiadne kredity. Pre použitie automatického doplňovania prosím pridaj kredity na svoj účet.\n\n[Otvoriť Nastavenia](command:kilo-code.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "GG.AI Code: Rýchla úloha",
  "kilocode:autocomplete.input.placeholder": "napr. 'refaktoruj túto funkciu, aby bola efektívnejšia'",
  "kilocode:autocomplete.commands.generateSuggestions": "GG.AI Code: Generovať navrhované úpravy",
  ...
  "kilocode:autocomplete.codeAction.title": "GG.AI Code: Navrhované úpravy",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "GG.AI Code Autocomplete je blokované konfliktom s GitHub Copilot. Pre vyriešenie tohto problému musíš zakázať inline návrhy Copilot.",
