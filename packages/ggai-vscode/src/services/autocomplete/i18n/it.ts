...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "GG.AI Code Autocomplete (disabilitato)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**Nessun credito nel tuo account**\n\nIl tuo account GG.AI Code non ha crediti. Per usare l'autocompletamento, aggiungi crediti al tuo account.\n\n[Apri Impostazioni](command:kilo-code.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "GG.AI Code: Attività Rapida",
  "kilocode:autocomplete.input.placeholder": "es., 'refactorizza questa funzione per renderla più efficiente'",
  "kilocode:autocomplete.commands.generateSuggestions": "GG.AI Code: Genera Modifiche Suggerite",
  ...
  "kilocode:autocomplete.codeAction.title": "GG.AI Code: Modifiche Suggerite",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "Il GG.AI Code Autocomplete è bloccato da un conflitto con GitHub Copilot. Per risolvere questo problema, devi disabilitare i suggerimenti in linea di Copilot.",
