...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "GG.AI Code Autocomplete (desactivat)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**No tens crèdits al teu compte**\n\nEl teu compte de GG.AI Code no té crèdits. Per utilitzar l'autocompletat, si us plau afegeix crèdits al teu compte.\n\n[Obrir Configuració](command:kilo-code.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "GG.AI Code: Tasca Ràpida",
  "kilocode:autocomplete.input.placeholder": "p. ex., 'refactoritza aquesta funció per ser més eficient'",
  "kilocode:autocomplete.commands.generateSuggestions": "GG.AI Code: Generar Edicions Suggerides",
  ...
  "kilocode:autocomplete.codeAction.title": "GG.AI Code: Edicions Suggerides",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "El GG.AI Code Autocomplete està sent bloquejat per un conflicte amb GitHub Copilot. Per solucionar això, has de desactivar els suggeriments en línia de Copilot.",
