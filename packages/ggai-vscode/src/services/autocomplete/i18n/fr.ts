...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "GG.AI Code Autocomplete (désactivé)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**Pas de crédits sur ton compte**\n\nTon compte GG.AI Code n'a pas de crédits. Pour utiliser l'autocomplétion, ajoute des crédits à ton compte.\n\n[Ouvrir les Paramètres](command:kilo-code.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "GG.AI Code : Tâche Rapide",
  "kilocode:autocomplete.input.placeholder": "ex., 'refactorise cette fonction pour plus d'efficacité'",
  "kilocode:autocomplete.commands.generateSuggestions": "GG.AI Code : Générer des Modifications Suggérées",
  ...
  "kilocode:autocomplete.codeAction.title": "GG.AI Code : Modifications Suggérées",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "Le GG.AI Code Autocomplete est bloqué par un conflit avec GitHub Copilot. Pour résoudre cela, tu dois désactiver les suggestions en ligne de Copilot.",
