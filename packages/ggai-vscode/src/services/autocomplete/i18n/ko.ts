...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "GG.AI Code Autocomplete (비활성화됨)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**계정에 크레딧이 없습니다**\n\nGG.AI Code 계정에 크레딧이 없습니다. 자동완성을 사용하려면 계정에 크레딧을 추가해 주세요.\n\n[설정 열기](command:kilo-code.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "GG.AI Code: 빠른 작업",
  "kilocode:autocomplete.input.placeholder": "예: '이 함수를 더 효율적으로 리팩토링해줘'",
  "kilocode:autocomplete.commands.generateSuggestions": "GG.AI Code: 제안된 편집 생성",
  ...
  "kilocode:autocomplete.codeAction.title": "GG.AI Code: 제안된 편집",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "GG.AI Code Autocomplete가 GitHub Copilot과의 충돌로 인해 차단되고 있습니다. 이를 해결하려면 Copilot의 인라인 제안을 비활성화해야 합니다.",
