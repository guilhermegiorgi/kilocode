...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "GG.AI Code Autocomplete (disabled)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**No credits in your account**\n\nYour GG.AI Code account has no credits. To use autocomplete, please add credits to your account.\n\n[Open Settings](command:kilo-code.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "GG.AI Code: Quick Task",
  "kilocode:autocomplete.input.placeholder": "e.g., 'refactor this function to be more efficient'",
  "kilocode:autocomplete.commands.generateSuggestions": "GG.AI Code: Generate Suggested Edits",
  ...
  "kilocode:autocomplete.codeAction.title": "GG.AI Code: Suggested Edits",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "The GG.AI Code Autocomplete is being blocked by a conflict with GitHub Copilot. To fix this, you must disable Copilot's inline suggestions.",
