...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "GG.AI Code Autocomplete (desabilitado)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**Sem créditos na sua conta**\n\nSua conta GG.AI Code não tem créditos. Para usar o autocompletar, adicione créditos à sua conta.\n\n[Abrir Configurações](command:kilo-code.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "GG.AI Code: Tarefa Rápida",
  "kilocode:autocomplete.input.placeholder": "ex., 'refatore esta função para ser mais eficiente'",
  "kilocode:autocomplete.commands.generateSuggestions": "GG.AI Code: Gerar Edições Sugeridas",
  ...
  "kilocode:autocomplete.codeAction.title": "GG.AI Code: Edições Sugeridas",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "O GG.AI Code Autocomplete está sendo bloqueado por um conflito com o GitHub Copilot. Para corrigir isso, você deve desabilitar as sugestões inline do Copilot.",
