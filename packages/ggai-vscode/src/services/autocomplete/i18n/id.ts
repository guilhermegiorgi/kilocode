...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "GG.AI Code Autocomplete (dinonaktifkan)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**Tidak ada kredit di akun kamu**\n\nAkun GG.AI Code kamu tidak memiliki kredit. Untuk menggunakan autocomplete, silakan tambahkan kredit ke akun kamu.\n\n[Buka Pengaturan](command:kilo-code.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "GG.AI Code: Tugas Cepat",
  "kilocode:autocomplete.input.placeholder": "mis., 'refaktor fungsi ini agar lebih efisien'",
  "kilocode:autocomplete.commands.generateSuggestions": "GG.AI Code: Hasilkan Suntingan yang Disarankan",
  ...
  "kilocode:autocomplete.codeAction.title": "GG.AI Code: Suntingan yang Disarankan",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "GG.AI Code Autocomplete diblokir oleh konflik dengan GitHub Copilot. Untuk memperbaiki ini, Anda harus menonaktifkan saran inline Copilot.",
