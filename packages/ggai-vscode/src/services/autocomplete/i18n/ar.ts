...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "GG.AI Code Autocomplete (معطل)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**لا يوجد رصيد في حسابك**\n\nحساب GG.AI Code الخاص بك لا يحتوي على رصيد. لاستخدام الإكمال التلقائي، يرجى إضافة رصيد إلى حسابك.\n\n[فتح الإعدادات](command:kilo-code.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "GG.AI Code: مهمة سريعة",
  "kilocode:autocomplete.input.placeholder": "مثال، 'أعد هيكلة هذه الدالة لتكون أكثر كفاءة'",
  "kilocode:autocomplete.commands.generateSuggestions": "GG.AI Code: إنشاء التعديلات المقترحة",
  ...
  "kilocode:autocomplete.codeAction.title": "GG.AI Code: التعديلات المقترحة",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "يتم حظر GG.AI Code Autocomplete بسبب تعارض مع GitHub Copilot. لإصلاح هذا، يجب عليك تعطيل اقتراحات Copilot المضمنة.",
