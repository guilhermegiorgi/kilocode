...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "GG.AI Code Autocomplete (deaktiviert)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**Kein Guthaben auf deinem Konto**\n\nDein GG.AI Code Konto hat kein Guthaben. Um Autocomplete zu nutzen, füge bitte Guthaben zu deinem Konto hinzu.\n\n[Einstellungen öffnen](command:kilo-code.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "GG.AI Code: Schnellaufgabe",
  "kilocode:autocomplete.input.placeholder": "z.B. 'refaktoriere diese Funktion für mehr Effizienz'",
  "kilocode:autocomplete.commands.generateSuggestions": "GG.AI Code: Bearbeitungsvorschläge generieren",
  ...
  "kilocode:autocomplete.codeAction.title": "GG.AI Code: Bearbeitungsvorschläge",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "Das GG.AI Code Autocomplete wird durch einen Konflikt mit GitHub Copilot blockiert. Um dies zu beheben, musst du Copilots Inline-Vorschläge deaktivieren.",
