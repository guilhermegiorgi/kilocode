...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "GG.AI Code Autocomplete (zakázáno)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**Na tvém účtu nejsou žádné kredity**\n\nTvůj účet GG.AI Code nemá žádné kredity. Pro použití automatického doplňování prosím přidej kredity na svůj účet.\n\n[Otevřít Nastavení](command:kilo-code.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "GG.AI Code: Rychlý úkol",
  "kilocode:autocomplete.input.placeholder": "např. 'refaktoruj tuto funkci, aby byla efektivnější'",
  "kilocode:autocomplete.commands.generateSuggestions": "GG.AI Code: Generovat navrhované úpravy",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "GG.AI Code Autocomplete je blokováno konfliktem s GitHub Copilot. Pro vyřešení tohoto problému musíš zakázat inline návrhy Copilot.",
