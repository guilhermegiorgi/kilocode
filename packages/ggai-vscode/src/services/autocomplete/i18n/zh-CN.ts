...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "GG.AI Code Autocomplete（已禁用）",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**账户余额不足**\n\n你的 GG.AI Code 账户没有余额。要使用自动补全功能，请为账户充值。\n\n[打开设置](command:kilo-code.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "GG.AI Code: 快速任务",
  "kilocode:autocomplete.input.placeholder": "例如：'重构这个函数使其更高效'",
  "kilocode:autocomplete.commands.generateSuggestions": "GG.AI Code: 生成建议编辑",
  ...
  "kilocode:autocomplete.codeAction.title": "GG.AI Code: 建议编辑",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "GG.AI Code Autocomplete 被与 GitHub Copilot 的冲突阻止。要解决此问题，你必须禁用 Copilot 的内联建议。",
