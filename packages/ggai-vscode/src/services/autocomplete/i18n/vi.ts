...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "GG.AI Code Autocomplete (đã tắt)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**Không có tín dụng trong tài khoản của bạn**\n\nTài khoản GG.AI Code của bạn không có tín dụng. Để sử dụng tự động hoàn thành, vui lòng thêm tín dụng vào tài khoản của bạn.\n\n[Mở Cài đặt](command:kilo-code.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "GG.AI Code: Tác Vụ Nhanh",
  "kilocode:autocomplete.input.placeholder": "ví dụ, 'tái cấu trúc hàm này để hiệu quả hơn'",
  "kilocode:autocomplete.commands.generateSuggestions": "GG.AI Code: Tạo Các Chỉnh Sửa Được Đề Xuất",
  ...
  "kilocode:autocomplete.codeAction.title": "GG.AI Code: Các Chỉnh Sửa Được Đề Xuất",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "GG.AI Code Autocomplete đang bị chặn do xung đột với GitHub Copilot. Để khắc phục điều này, bạn phải tắt các gợi ý inline của Copilot.",
