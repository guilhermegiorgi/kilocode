...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "GG.AI Code Autocomplete（無効）",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**アカウントにクレジットがありません**\n\nGG.AI Code アカウントにクレジットがありません。オートコンプリートを使用するには、アカウントにクレジットを追加してください。\n\n[設定を開く](command:kilo-code.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "GG.AI Code: クイックタスク",
  "kilocode:autocomplete.input.placeholder": "例：「この関数をより効率的にリファクタリングして」",
  "kilocode:autocomplete.commands.generateSuggestions": "GG.AI Code: 編集提案を生成",
  ...
  "kilocode:autocomplete.codeAction.title": "GG.AI Code: 編集提案",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "GG.AI Code AutocompleteがGitHub Copilotとの競合によってブロックされています。これを修正するには、Copilotのインライン提案を無効にする必要があります。",
