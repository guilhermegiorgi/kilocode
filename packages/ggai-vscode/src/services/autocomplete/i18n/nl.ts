...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "GG.AI Code Autocomplete (uitgeschakeld)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**Geen tegoed op je account**\n\nJe GG.AI Code account heeft geen tegoed. Om autocomplete te gebruiken, voeg tegoed toe aan je account.\n\n[Instellingen openen](command:kilo-code.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "GG.AI Code: Snelle Taak",
  "kilocode:autocomplete.input.placeholder": "bijv., 'refactor deze functie om efficiënter te zijn'",
  "kilocode:autocomplete.commands.generateSuggestions": "GG.AI Code: Voorgestelde Bewerkingen Genereren",
  ...
  "kilocode:autocomplete.codeAction.title": "GG.AI Code: Voorgestelde Bewerkingen",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "De GG.AI Code Autocomplete wordt geblokkeerd door een conflict met GitHub Copilot. Om dit op te lossen, moet je Copilot's inline suggesties uitschakelen.",
