...
import { registerCodeActions, registerTerminalActions, GGAIActionProvider } from "./services/code-actions"

export function activate(context: vscode.ExtensionContext) {
  console.log("GG.AI extension is now active")
  ...
  context.subscriptions.push(
    vscode.languages.registerCodeActionsProvider(
      { scheme: "file" },
      new GGAIActionProvider(),
      GGAIActionProvider.metadata,
    ),
  )
