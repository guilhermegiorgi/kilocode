...
export class WorktreeManager {
  ...
  async ensureGitExclude(): Promise<void> {
    ...
    await this.addExcludeEntry(excludePath, ".kilocode/worktrees/", "GG.AI agent worktrees")
    await this.addExcludeEntry(excludePath, ".kilocode/agent-manager.json", "Kilo Agent Manager state")
    await this.addExcludeEntry(excludePath, ".kilocode/setup-script", "GG.AI worktree setup script")
    await this.addExcludeEntry(excludePath, ".kilocode/setup-script.sh", "GG.AI worktree setup script")
    await this.addExcludeEntry(excludePath, ".kilocode/setup-script.ps1", "GG.AI worktree setup script")
    await this.addExcludeEntry(excludePath, ".kilocode/setup-script.cmd", "GG.AI worktree setup script")
    await this.addExcludeEntry(excludePath, ".kilocode/setup-script.bat", "GG.AI worktree setup script")
  }
