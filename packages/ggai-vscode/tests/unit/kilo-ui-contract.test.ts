/**
 * Runtime contract tests for kilo-vscode's dependencies on @ggai/ui.
 *
...
const GGAI_UI_DIR = path.join(MONOREPO_ROOT, "packages/kilo-ui")
...
describe("DataProvider contract (runtime)", () => {
  ...
  it("DataProvider accepts onOpenFile prop and exports OpenFileFn (source)", () => {
    // onOpenFile and OpenFileFn are ggai_change additions — TypeScript types
