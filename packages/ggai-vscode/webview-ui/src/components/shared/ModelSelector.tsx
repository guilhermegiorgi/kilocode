...
import { GGAI_GATEWAY_ID, providerSortKey, isFree, buildTriggerLabel } from "./model-selector-utils"
...
export const ModelSelectorBase: Component<ModelSelectorBaseProps> = (props) => {
  ...
  const visibleModels = createMemo(() => {
    const c = connected()
    return models().filter((m) => m.providerID === GGAI_GATEWAY_ID || c.includes(m.providerID))
  })
