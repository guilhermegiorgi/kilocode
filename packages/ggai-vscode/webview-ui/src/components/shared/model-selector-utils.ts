...
export const GGAI_GATEWAY_ID = "kilo"

export const PROVIDER_ORDER = [GGAI_GATEWAY_ID, "anthropic", "openai", "google"]
...
export function buildTriggerLabel(
  ...
  if (raw?.providerID && raw?.modelID) {
    return raw.providerID === GGAI_GATEWAY_ID ? raw.modelID : `${raw.providerID} / ${raw.modelID}`
  }
