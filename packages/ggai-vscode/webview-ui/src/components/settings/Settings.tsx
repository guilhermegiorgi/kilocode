...
import { Tabs } from "@ggai/ui/tabs"
import { Tooltip } from "@ggai/ui/tooltip"
...
import AboutGGAITab from "./AboutGGAITab"
    ...
    <div style={{ display: "flex", "flex-direction": "column", height: "100%" }}>
      ...
      <Tabs orientation="vertical" variant="settings" defaultValue="providers" style={{ flex: 1, overflow: "hidden" }}>
        <Tabs.List>
          ...
          <Tabs.Trigger value="aboutGGAI">
            <Icon name="help" />
            {language.t("settings.aboutGGAI.title")}
          </Tabs.Trigger>
        </Tabs.List>
        ...
        <Tabs.Content value="aboutGGAI">
          <h3>{language.t("settings.aboutGGAI.title")}</h3>
          <AboutGGAITab
