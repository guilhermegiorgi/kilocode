export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من GG.AI",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في GG.AI.",
  ...
  "provider.connect.opencodeZen.line1":
    "يمنحك GG.AI Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في GG.AI.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في GG.AI.",
  ...
  "dialog.server.description": "تبديل خادم GG.AI الذي يتصل به هذا التطبيق.",
  ...
  "toast.update.description": "نسخة جديدة من GG.AI ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق GG.AI",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن GG.AI لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن GG.AI نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ GG.AI",
  "settings.general.row.appearance.title": "المظهر",
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور GG.AI على جهازك",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة GG.AI.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل GG.AI",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من GG.AI.",
  ...
  "deviceAuth.title": "تسجيل الدخول إلى GG.AI Code",
  ...
  "profile.action.login": "تسجيل الدخول باستخدام GG.AI Code",
  ...
  "settings.aboutGGAI.title": "حول GG.AI Code",

  "session.messages.empty": "ابدأ محادثة بكتابة رسالة أدناه.",
  "session.messages.welcome":
    "GG.AI Code هو مساعد ترميز بالذكاء الاصطناعي. اطلب منه بناء ميزات أو إصلاح أخطاء أو شرح قاعدة الشيفرة.",
  ...
  "settings.aboutGGAI.status.connected": "متصل",
  "settings.aboutGGAI.status.connecting": "جارٍ الاتصال...",
  "settings.aboutGGAI.status.disconnected": "غير متصل",
  "settings.aboutGGAI.status.error": "خطأ",
  "settings.aboutGGAI.cliServer": "خادم CLI",
  "settings.aboutGGAI.status.label": "الحالة:",
  "settings.aboutGGAI.port.label": "المنفذ:",
  "settings.aboutGGAI.versionInfo": "معلومات الإصدار",
  "settings.aboutGGAI.version.label": "الإصدار:",
  "settings.aboutGGAI.extensionName": "إضافة GG.AI Code",
  "settings.aboutGGAI.community": "المجتمع والدعم",
  "settings.aboutGGAI.feedback.prefix": "إذا كان لديك أي أسئلة أو ملاحظات، لا تتردد في فتح مشكلة على",
  "settings.aboutGGAI.feedback.or": "أو",
  "settings.aboutGGAI.support.prefix": "لأسئلة الفوترة أو الحساب، تواصل مع دعم العملاء على",
  "settings.aboutGGAI.resetSettings.title": "إعادة تعيين الإعدادات",
  "settings.aboutGGAI.resetSettings.description":
    "إعادة تعيين جميع إعدادات إضافة GG.AI Code إلى قيمها الافتراضية. لا يؤثر هذا على تكوين CLI أو الواجهة الخلفية.",
  "settings.aboutGGAI.resetSettings.button": "إعادة تعيين جميع الإعدادات",
  ...
  "settings.language.description": 'اختر اللغة لواجهة GG.AI Code. "تلقائي" يستخدم لغة عرض VS Code.',
  ...
  "settings.aboutGGAI.legacyMigration.title": "ترحيل الإصدار القديم",
  "settings.aboutGGAI.legacyMigration.description":
    "ترحيل الإعدادات من تثبيت سابق لـ GG.AI Code، بما في ذلك مفاتيح API لمقدمي الخدمة والنموذج الافتراضي.",
  "migration.welcome.title": "مرحبًا بك في GG.AI Code الجديد",
  "migration.welcome.detected": "لقد اكتشفنا إعدادات من تثبيت سابق لـ GG.AI Code.",
  ...
  "migration.steps.subtitle": "لقد وجدنا إعدادات من تثبيت GG.AI Code السابق. اختر ما تريد نقله.",
