...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av GG.AI",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i GG.AI.",
  ...
  "provider.connect.opencodeZen.line1":
    "GG.AI Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i GG.AI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i GG.AI.",
  ...
  "dialog.server.description": "Bytt hvilken GG.AI-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av GG.AI ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til GG.AI-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at GG.AI ikke støtter MCP-autentisering ennå.',
  ...
  "settings.general.row.language.description": "Endre visningsspråket for GG.AI",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan GG.AI ser ut på enheten din",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan GG.AI er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når GG.AI starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av GG.AI.",
  ...
  "deviceAuth.title": "Logg inn på GG.AI Code",
  ...
  "profile.action.login": "Logg inn med GG.AI Code",
  ...
  "settings.aboutGGAI.title": "Om GG.AI Code",

  "session.messages.empty": "Start en samtale ved å skrive en melding nedenfor.",
  "session.messages.welcome":
    "GG.AI Code er en AI-kodingsassistent. Be den om å bygge funksjoner, fikse feil eller forklare kodebasen din.",
  ...
  "settings.aboutGGAI.status.connected": "Tilkoblet",
  "settings.aboutGGAI.status.connecting": "Kobler til...",
  "settings.aboutGGAI.status.disconnected": "Frakoblet",
  "settings.aboutGGAI.status.error": "Feil",
  "settings.aboutGGAI.cliServer": "CLI-server",
  "settings.aboutGGAI.status.label": "Status:",
  "settings.aboutGGAI.port.label": "Port:",
  "settings.aboutGGAI.versionInfo": "Versjonsinformasjon",
  "settings.aboutGGAI.version.label": "Versjon:",
  "settings.aboutGGAI.extensionName": "GG.AI Code-utvidelse",
  "settings.aboutGGAI.community": "Fellesskap og støtte",
  "settings.aboutGGAI.feedback.prefix": "Hvis du har spørsmål eller tilbakemeldinger, åpne gjerne en issue på",
  "settings.aboutGGAI.feedback.or": "eller",
  "settings.aboutGGAI.support.prefix": "For fakturerings- eller kontospørsmål, kontakt kundestøtte på",
  "settings.aboutGGAI.resetSettings.title": "Tilbakestill innstillinger",
  "settings.aboutGGAI.resetSettings.description":
    "Tilbakestill alle GG.AI Code-utvidelsesinnstillinger til standardverdier. Dette påvirker ikke CLI- eller backend-konfigurasjon.",
  "settings.aboutGGAI.resetSettings.button": "Tilbakestill alle innstillinger",
  ...
  "settings.language.description": 'Velg språket for GG.AI Code-grensesnittet. "Auto" bruker VS Codes visningsspråk.',
  ...
  "settings.aboutGGAI.legacyMigration.title": "Migrering fra eldre versjon",
  "settings.aboutGGAI.legacyMigration.description":
    "Migrer innstillinger fra en tidligere installasjon av GG.AI Code, inkludert API-nøkler for leverandører og standardmodell.",
  "migration.welcome.title": "Velkommen til nye GG.AI Code",
  "migration.welcome.detected": "Vi oppdaget innstillinger fra en tidligere installasjon av GG.AI Code.",
  ...
  "migration.steps.subtitle":
    "Vi fant innstillinger fra din tidligere GG.AI Code-installasjon. Velg hva du vil ta med over.",
