export const dict = {
  ...
  "deviceAuth.title": "Prijavite se u GG.AI Code",
  ...
  "profile.action.login": "Prijavite se putem GG.AI Code",
  ...
  "settings.aboutGGAI.title": "O GG.AI Code-u",

  "session.messages.empty": "Započnite razgovor unosom poruke ispod.",
  "session.messages.welcome":
    "GG.AI Code je AI asistent za programiranje. Zatražite da gradi funkcionalnosti, ispravlja greške ili objasni vašu bazu koda.",
  ...
  "settings.aboutGGAI.status.connected": "Povezano",
  "settings.aboutGGAI.status.connecting": "Povezivanje...",
  "settings.aboutGGAI.status.disconnected": "Odspojeno",
  "settings.aboutGGAI.status.error": "Greška",
  "settings.aboutGGAI.cliServer": "CLI server",
  "settings.aboutGGAI.status.label": "Status:",
  "settings.aboutGGAI.port.label": "Port:",
  "settings.aboutGGAI.versionInfo": "Informacije o verziji",
  "settings.aboutGGAI.version.label": "Verzija:",
  "settings.aboutGGAI.extensionName": "GG.AI Code ekstenzija",
  "settings.aboutGGAI.community": "Zajednica i podrška",
  "settings.aboutGGAI.feedback.prefix": "Ako imate pitanja ili povratne informacije, slobodno otvorite issue na",
  "settings.aboutGGAI.feedback.or": "ili",
  "settings.aboutGGAI.support.prefix": "Za pitanja o naplati ili računu, kontaktirajte korisničku podršku na",
  "settings.aboutGGAI.resetSettings.title": "Resetovanje postavki",
  "settings.aboutGGAI.resetSettings.description":
    "Resetujte sve postavke GG.AI Code ekstenzije na zadane vrijednosti. Ovo ne utiče na CLI ili backend konfiguraciju.",
  "settings.aboutGGAI.resetSettings.button": "Resetuj sve postavke",
  ...
  "settings.language.description": 'Odaberite jezik za GG.AI Code sučelje. "Auto" koristi jezik prikaza VS Code-a.',
  ...
  "settings.aboutGGAI.legacyMigration.title": "Migracija sa prethodne verzije",
  "settings.aboutGGAI.legacyMigration.description":
    "Migrirajte postavke iz prethodne instalacije GG.AI Code, uključujući API ključeve provajdera i podrazumijevani model.",
  "migration.welcome.title": "Dobrodošli u novi GG.AI Code",
  "migration.welcome.detected": "Otkrili smo postavke iz prethodne instalacije GG.AI Code.",
  ...
  "migration.steps.subtitle":
    "Pronašli smo postavke iz vaše prethodne instalacije GG.AI Code. Odaberite šta želite prenijeti.",
