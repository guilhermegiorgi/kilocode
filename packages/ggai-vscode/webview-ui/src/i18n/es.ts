export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por GG.AI",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en GG.AI.",
  ...
  "provider.connect.opencodeZen.line1":
    "GG.AI Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.opencodeZen.visit.link": "https://ggai.ai/zen",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en GG.AI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en GG.AI.",
  ...
  "dialog.server.description": "Cambiar a qué servidor de GG.AI se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de GG.AI ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de GG.AI",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, GG.AI no soporta autenticación MCP todavía.',
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para GG.AI",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve GG.AI en tu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de GG.AI.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia GG.AI",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de GG.AI.",
  ...
  "deviceAuth.title": "Iniciar sesión en GG.AI Code",
  ...
  "profile.action.login": "Iniciar sesión con GG.AI Code",
  ...
  "settings.aboutGGAI.title": "Acerca de GG.AI Code",

  "session.messages.empty": "Inicia una conversación escribiendo un mensaje a continuación.",
  "session.messages.welcome":
    "GG.AI Code es un asistente de programación con IA. Pídele que cree funcionalidades, corrija errores o explique tu código.",
  ...
  "settings.aboutGGAI.status.connected": "Conectado",
  "settings.aboutGGAI.status.connecting": "Conectando...",
  "settings.aboutGGAI.status.disconnected": "Desconectado",
  "settings.aboutGGAI.status.error": "Error",
  "settings.aboutGGAI.cliServer": "Servidor CLI",
  "settings.aboutGGAI.status.label": "Estado:",
  "settings.aboutGGAI.port.label": "Puerto:",
  "settings.aboutGGAI.versionInfo": "Información de versión",
  "settings.aboutGGAI.version.label": "Versión:",
  "settings.aboutGGAI.extensionName": "Extensión GG.AI Code",
  "settings.aboutGGAI.community": "Comunidad y soporte",
  "settings.aboutGGAI.feedback.prefix": "Si tienes preguntas o comentarios, abre un issue en",
  "settings.aboutGGAI.feedback.or": "o",
  "settings.aboutGGAI.support.prefix": "Para preguntas de facturación o cuenta, contacta al Soporte al Cliente en",
  "settings.aboutGGAI.resetSettings.title": "Restablecer configuración",
  "settings.aboutGGAI.resetSettings.description":
    "Restablecer todas las configuraciones de la extensión GG.AI Code a sus valores predeterminados. Esto no afecta la configuración del CLI o del backend.",
  "settings.aboutGGAI.resetSettings.button": "Restablecer toda la configuración",
  ...
  "settings.language.description":
    'Elige el idioma de la interfaz de GG.AI Code. "Auto" utiliza el idioma de visualización de VS Code.',
  ...
  "settings.aboutGGAI.legacyMigration.title": "Migración heredada",
  "settings.aboutGGAI.legacyMigration.description":
    "Migra la configuración de una instalación anterior de GG.AI Code, incluyendo las claves API de proveedores y el modelo predeterminado.",
  "migration.welcome.title": "Bienvenido al nuevo GG.AI Code",
  "migration.welcome.detected": "Hemos detectado una configuración de una instalación anterior de GG.AI Code.",
  ...
  "migration.steps.subtitle":
    "Encontramos configuraciones de tu instalación anterior de GG.AI Code. Elige qué deseas transferir.",
