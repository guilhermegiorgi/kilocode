export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от GG.AI",
  ...
  "provider.connect.apiKey.description":
    "Введите ваш API ключ {{provider}} для подключения аккаунта и использования моделей {{provider}} в GG.AI.",
  ...
  "provider.connect.opencodeZen.line1":
    "GG.AI Zen даёт вам доступ к отобранным надёжным оптимизированным моделям для агентов программирования.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в GG.AI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в GG.AI.",
  ...
  "dialog.server.description": "Переключите сервер GG.AI к которому подключается приложение.",
  ...
  "toast.update.description": "Новая версия GG.AI ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде GG.AI",
  ...
  "error.chain.mcpFailed":
    'MCP сервер "{{name}}" завершился с ошибкой. Обратите внимание, что GG.AI пока не поддерживает MCP авторизацию.',
  ...
  "settings.general.row.language.description": "Изменить язык отображения GG.AI",
  "settings.general.row.appearance.title": "Внешний вид",
  "settings.general.row.appearance.description": "Настройте как GG.AI выглядит на вашем устройстве",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление GG.AI.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске GG.AI",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию GG.AI.",
  ...
  "deviceAuth.title": "Войти в GG.AI Code",
  ...
  "profile.action.login": "Войти через GG.AI Code",
  ...
  "settings.aboutGGAI.title": "О GG.AI Code",

  "session.messages.empty": "Начните разговор, введя сообщение ниже.",
  "session.messages.welcome":
    "GG.AI Code — это AI-помощник для программирования. Попросите его создать функции, исправить ошибки или объяснить вашу кодовую базу.",
  ...
  "settings.aboutGGAI.status.connected": "Подключено",
  "settings.aboutGGAI.status.connecting": "Подключение...",
  "settings.aboutGGAI.status.disconnected": "Отключено",
  "settings.aboutGGAI.status.error": "Ошибка",
  "settings.aboutGGAI.cliServer": "CLI-сервер",
  "settings.aboutGGAI.status.label": "Статус:",
  "settings.aboutGGAI.port.label": "Порт:",
  "settings.aboutGGAI.versionInfo": "Информация о версии",
  "settings.aboutGGAI.version.label": "Версия:",
  "settings.aboutGGAI.extensionName": "Расширение GG.AI Code",
  "settings.aboutGGAI.community": "Сообщество и поддержка",
  "settings.aboutGGAI.feedback.prefix": "Если у вас есть вопросы или отзывы, создайте issue на",
  "settings.aboutGGAI.feedback.or": "или",
  "settings.aboutGGAI.support.prefix": "По вопросам оплаты или аккаунта обращайтесь в службу поддержки по адресу",
  "settings.aboutGGAI.resetSettings.title": "Сброс настроек",
  "settings.aboutGGAI.resetSettings.description":
    "Сбросить все настройки расширения GG.AI Code до значений по умолчанию. Это не влияет на конфигурацию CLI или бэкенда.",
  "settings.aboutGGAI.resetSettings.button": "Сбросить все настройки",
  ...
  "settings.language.description": "Выберите язык интерфейса GG.AI Code. «Авто» использует язык отображения VS Code.",
  ...
  "settings.aboutGGAI.legacyMigration.title": "Миграция с устаревшей версии",
  "settings.aboutGGAI.legacyMigration.description":
    "Перенос настроек из предыдущей установки GG.AI Code, включая API-ключи провайдеров и модель по умолчанию.",
  "migration.welcome.title": "Добро пожаловать в новый GG.AI Code",
  "migration.welcome.detected": "Мы обнаружили настройки от предыдущей установки GG.AI Code.",
  ...
  "migration.steps.subtitle":
    "Мы нашли настройки от вашей предыдущей установки GG.AI Code. Выберите, что нужно перенести.",
