export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "โมเดลฟรีที่จัดหาให้โดย GG.AI",
  ...
  "provider.connect.apiKey.description":
    "ป้อนคีย์ API ของ {{provider}} เพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน GG.AI",
  ...
  "provider.connect.opencodeZen.line1":
    "GG.AI Zen ให้คุณเข้าถึงชุดโมเดลที่เชื่อถือได้และปรับแต่งแล้วสำหรับเอเจนต์การเขียนโค้ด",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " เพื่อรวบรวมรหัสการอนุญาตของคุณเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน GG.AI",
  ...
  "provider.connect.oauth.auto.visit.suffix": " และป้อนรหัสด้านล่างเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน GG.AI",
  ...
  "dialog.server.description": "สลับเซิร์ฟเวอร์ GG.AI ที่แอปนี้เชื่อมต่อด้วย",
  ...
  "toast.update.description": "เวอร์ชันใหม่ของ GG.AI ({{version}}) พร้อมใช้งานสำหรับติดตั้ง",
  ...
  "error.page.report.prefix": "โปรดรายงานข้อผิดพลาดนี้ให้ทีม GG.AI",
  ...
  "error.chain.mcpFailed": 'เซิร์ฟเวอร์ MCP "{{name}}" ล้มเหลว โปรดทราบว่า GG.AI ยังไม่รองรับการตรวจสอบสิทธิ์ MCP',
  ...
  "settings.general.row.language.description": "เปลี่ยนภาษาที่แสดงสำหรับ GG.AI",
  "settings.general.row.appearance.title": "รูปลักษณ์",
  "settings.general.row.appearance.description": "ปรับแต่งวิธีการที่ GG.AI มีลักษณะบนอุปกรณ์ของคุณ",
  "settings.general.row.theme.title": "ธีม",
  "settings.general.row.theme.description": "ปรับแต่งวิธีการที่ GG.AI มีธีม",
  ...
  "deviceAuth.title": "เข้าสู่ระบบ GG.AI Code",
  ...
  "profile.action.login": "เข้าสู่ระบบด้วย GG.AI Code",
  ...
  "settings.aboutGGAI.title": "เกี่ยวกับ GG.AI Code",

  "session.messages.empty": "เริ่มการสนทนาโดยพิมพ์ข้อความด้านล่าง",
  "session.messages.welcome": "GG.AI Code เป็นผู้ช่วยเขียนโค้ด AI ขอให้สร้างฟีเจอร์ แก้ไขบัก หรืออธิบายโค้ดเบสของคุณ",
  ...
  "settings.aboutGGAI.status.connected": "เชื่อมต่อแล้ว",
  "settings.aboutGGAI.status.connecting": "กำลังเชื่อมต่อ...",
  "settings.aboutGGAI.status.disconnected": "ตัดการเชื่อมต่อ",
  "settings.aboutGGAI.status.error": "ข้อผิดพลาด",
  "settings.aboutGGAI.cliServer": "เซิร์ฟเวอร์ CLI",
  "settings.aboutGGAI.status.label": "สถานะ:",
  "settings.aboutGGAI.port.label": "พอร์ต:",
  "settings.aboutGGAI.versionInfo": "ข้อมูลเวอร์ชัน",
  "settings.aboutGGAI.version.label": "เวอร์ชัน:",
  "settings.aboutGGAI.extensionName": "ส่วนขยาย GG.AI Code",
  "settings.aboutGGAI.community": "ชุมชนและการสนับสนุน",
  "settings.aboutGGAI.feedback.prefix": "หากคุณมีคำถามหรือข้อเสนอแนะ สามารถเปิด issue ได้ที่",
  "settings.aboutGGAI.feedback.or": "หรือ",
  "settings.aboutGGAI.support.prefix": "สำหรับคำถามเกี่ยวกับการเรียกเก็บเงินหรือบัญชี ติดต่อฝ่ายสนับสนุนลูกค้าที่",
  "settings.aboutGGAI.resetSettings.title": "รีเซ็ตการตั้งค่า",
  "settings.aboutGGAI.resetSettings.description":
    "รีเซ็ตการตั้งค่าส่วนขยาย GG.AI Code ทั้งหมดเป็นค่าเริ่มต้น ไม่ส่งผลกระทบต่อการกำหนดค่า CLI หรือแบ็กเอนด์",
  "settings.aboutGGAI.resetSettings.button": "รีเซ็ตการตั้งค่าทั้งหมด",
  ...
  "settings.language.description": 'เลือกภาษาสำหรับ UI ของ GG.AI Code "อัตโนมัติ" จะใช้ภาษาการแสดงผลของ VS Code',
  ...
  "settings.aboutGGAI.legacyMigration.title": "การย้ายข้อมูลจากเวอร์ชันดั้งเดิม",
  "settings.aboutGGAI.legacyMigration.description":
    "ย้ายการตั้งค่าจากการติดตั้ง GG.AI Code ก่อนหน้านี้ รวมถึงคีย์ API ของผู้ให้บริการและโมเดลเริ่มต้น",
  "migration.welcome.title": "ยินดีต้อนรับสู่ GG.AI Code โฉมใหม่",
  "migration.welcome.detected": "เราตรวจพบการตั้งค่าจากการติดตั้ง GG.AI Code ก่อนหน้านี้",
  ...
  "migration.steps.subtitle": "เราพบการตั้งค่าจากการติดตั้ง GG.AI Code ก่อนหน้านี้ของคุณ เลือกสิ่งที่จะนำเข้ามาด้วย",
