...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 GG.AI 中使用 {{provider}} 模型。",
  ...
  "provider.connect.opencodeZen.line1": "GG.AI Zen 為你提供一組精選的可靠最佳化模型，用於程式碼 Agent。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 GG.AI 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 並輸入以下程式碼，以連線你的帳戶並在 GG.AI 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切換此應用程式連線的 GG.AI 伺服器。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 GG.AI 團隊",
  ...
  "settings.general.row.language.description": "變更 GG.AI 的顯示語言",
  "settings.general.row.appearance.title": "外觀",
  "settings.general.row.appearance.description": "自訂 GG.AI 在你的裝置上的外觀",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 GG.AI 的主題。",
  ...
  "settings.updates.row.startup.description": "在 GG.AI 啟動時自動檢查更新",
  ...
  "deviceAuth.title": "登入 GG.AI Code",
  ...
  "profile.action.login": "使用 GG.AI Code 登入",
  ...
  "settings.aboutGGAI.title": "關於 GG.AI Code",

  "session.messages.empty": "在下方輸入訊息以開始對話。",
  "session.messages.welcome": "GG.AI Code 是一個 AI 程式設計助手。讓它幫你建構功能、修復 bug 或解釋程式碼庫。",
  ...
  "settings.aboutGGAI.status.connected": "已連線",
  "settings.aboutGGAI.status.connecting": "連線中...",
  "settings.aboutGGAI.status.disconnected": "已中斷",
  "settings.aboutGGAI.status.error": "錯誤",
  "settings.aboutGGAI.cliServer": "CLI 伺服器",
  "settings.aboutGGAI.status.label": "狀態：",
  "settings.aboutGGAI.port.label": "連接埠：",
  "settings.aboutGGAI.versionInfo": "版本資訊",
  "settings.aboutGGAI.version.label": "版本：",
  "settings.aboutGGAI.extensionName": "GG.AI Code 擴充功能",
  "settings.aboutGGAI.community": "社群與支援",
  "settings.aboutGGAI.feedback.prefix": "如果您有任何問題或回饋，歡迎在以下平台提交 issue",
  "settings.aboutGGAI.feedback.or": "或",
  "settings.aboutGGAI.support.prefix": "如有帳單或帳戶問題，請聯繫客戶支援",
  "settings.aboutGGAI.resetSettings.title": "重置設定",
  "settings.aboutGGAI.resetSettings.description":
    "將所有 GG.AI Code 擴充功能設定重置為預設值。這不會影響 CLI 或後端設定。",
  "settings.aboutGGAI.resetSettings.button": "重置所有設定",
  ...
  "settings.language.description": "選擇 GG.AI Code 介面的語言。「自動」使用 VS Code 的顯示語言。",
  ...
  "settings.aboutGGAI.legacyMigration.title": "舊版轉移",
  "settings.aboutGGAI.legacyMigration.description":
    "從先前安裝的 GG.AI Code 轉移設定，包含供應商 API 金鑰與預設模型。",
  "migration.welcome.title": "歡迎使用全新的 GG.AI Code",
  "migration.welcome.detected": "我們偵測到先前安裝的 GG.AI Code 設定。",
  ...
  "migration.steps.subtitle": "我們找到了您先前 GG.AI Code 安裝的設定。請選擇要保留的項目。",
