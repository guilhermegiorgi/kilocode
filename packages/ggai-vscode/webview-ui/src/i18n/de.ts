...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von GG.AI",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in GG.AI zu nutzen.",
  ...
  "provider.connect.opencodeZen.line1":
    "GG.AI Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in GG.AI zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in GG.AI zu nutzen.",
  ...
  "dialog.server.description": "Wechseln Sie den GG.AI-Server, mit dem sich diese App verbindet.",
  ...
  "toast.update.description": "Eine neue Version von GG.AI ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem GG.AI-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: GG.AI unterstützt noch keine MCP-Authentifizierung.',
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für GG.AI ändern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie GG.AI auf Ihrem Gerät aussieht",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von GG.AI anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von GG.AI automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von GG.AI.",
  ...
  "deviceAuth.title": "Bei GG.AI Code anmelden",
  ...
  "profile.action.login": "Mit GG.AI Code anmelden",
  ...
  "settings.aboutGGAI.title": "Über GG.AI Code",

  "session.messages.empty": "Starten Sie eine Unterhaltung, indem Sie unten eine Nachricht eingeben.",
  "session.messages.welcome":
    "GG.AI Code ist ein KI-Programmierassistent. Bitten Sie ihn, Funktionen zu erstellen, Fehler zu beheben oder Ihre Codebasis zu erklären.",
  ...
  "settings.aboutGGAI.status.connected": "Verbunden",
  "settings.aboutGGAI.status.connecting": "Verbindung wird hergestellt...",
  "settings.aboutGGAI.status.disconnected": "Getrennt",
  "settings.aboutGGAI.status.error": "Fehler",
  "settings.aboutGGAI.cliServer": "CLI-Server",
  "settings.aboutGGAI.status.label": "Status:",
  "settings.aboutGGAI.port.label": "Port:",
  "settings.aboutGGAI.versionInfo": "Versionsinformationen",
  "settings.aboutGGAI.version.label": "Version:",
  "settings.aboutGGAI.extensionName": "GG.AI Code Erweiterung",
  "settings.aboutGGAI.community": "Community & Support",
  "settings.aboutGGAI.feedback.prefix": "Bei Fragen oder Feedback können Sie ein Issue eröffnen auf",
  "settings.aboutGGAI.feedback.or": "oder",
  "settings.aboutGGAI.support.prefix":
    "Bei Abrechnungs- oder Kontofragen wenden Sie sich an den Kundensupport unter",
  "settings.aboutGGAI.resetSettings.title": "Einstellungen zurücksetzen",
  "settings.aboutGGAI.resetSettings.description":
    "Alle GG.AI Code-Erweiterungseinstellungen auf Standardwerte zurücksetzen. Dies hat keinen Einfluss auf die CLI- oder Backend-Konfiguration.",
  "settings.aboutGGAI.resetSettings.button": "Alle Einstellungen zurücksetzen",
  ...
  "settings.language.description":
    'Wählen Sie die Sprache für die GG.AI Code Oberfläche. „Auto" verwendet die VS Code Anzeigesprache.',
  ...
  "settings.aboutGGAI.legacyMigration.title": "Legacy-Migration",
  "settings.aboutGGAI.legacyMigration.description":
    "Migrieren Sie Einstellungen von einer früheren Installation von GG.AI Code, einschließlich Anbieter-API-Schlüsseln und dem Standardmodell.",
  "migration.welcome.title": "Willkommen beim neuen GG.AI Code",
  "migration.welcome.detected": "Wir haben Einstellungen aus einer früheren Installation von GG.AI Code erkannt.",
  ...
  "migration.steps.subtitle":
    "Wir haben Einstellungen aus Ihrer vorherigen GG.AI Code-Installation gefunden. Wählen Sie aus, was übernommen werden soll.",
