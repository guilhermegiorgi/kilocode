export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez GG.AI",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w GG.AI.",
  ...
  "provider.connect.opencodeZen.line1":
    "GG.AI Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w GG.AI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w GG.AI.",
  ...
  "dialog.server.description": "Przełącz serwer GG.AI, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja GG.AI ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu GG.AI",
  ...
  "error.chain.mcpFailed":
    'Serwer MCP "{{name}}" nie powiódł się. Uwaga, GG.AI nie obsługuje jeszcze uwierzytelniania MCP.',
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla GG.AI",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd GG.AI na swoim urządzeniu",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw GG.AI.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania GG.AI",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji GG.AI.",
  ...
  "deviceAuth.title": "Zaloguj się do GG.AI Code",
  ...
  "profile.action.login": "Zaloguj się przez GG.AI Code",
  ...
  "settings.aboutGGAI.title": "O GG.AI Code",

  "session.messages.empty": "Rozpocznij rozmowę, wpisując wiadomość poniżej.",
  "session.messages.welcome":
    "GG.AI Code to asystent programowania AI. Poproś go o tworzenie funkcji, naprawę błędów lub wyjaśnienie bazy kodu.",
  ...
  "settings.aboutGGAI.status.connected": "Połączono",
  "settings.aboutGGAI.status.connecting": "Łączenie...",
  "settings.aboutGGAI.status.disconnected": "Rozłączono",
  "settings.aboutGGAI.status.error": "Błąd",
  "settings.aboutGGAI.cliServer": "Serwer CLI",
  "settings.aboutGGAI.status.label": "Status:",
  "settings.aboutGGAI.port.label": "Port:",
  "settings.aboutGGAI.versionInfo": "Informacje o wersji",
  "settings.aboutGGAI.version.label": "Wersja:",
  "settings.aboutGGAI.extensionName": "Rozszerzenie GG.AI Code",
  "settings.aboutGGAI.community": "Społeczność i wsparcie",
  "settings.aboutGGAI.feedback.prefix": "Jeśli masz pytania lub uwagi, śmiało otwórz zgłoszenie na",
  "settings.aboutGGAI.feedback.or": "lub",
  "settings.aboutGGAI.support.prefix":
    "W sprawach rozliczeń lub konta skontaktuj się z obsługą klienta pod adresem",
  "settings.aboutGGAI.resetSettings.title": "Resetuj ustawienia",
  "settings.aboutGGAI.resetSettings.description":
    "Zresetuj wszystkie ustawienia rozszerzenia GG.AI Code do wartości domyślnych. Nie wpływa to na konfigurację CLI ani backendu.",
  "settings.aboutGGAI.resetSettings.button": "Resetuj wszystkie ustawienia",
  ...
  "settings.language.description": 'Wybierz język interfejsu GG.AI Code. „Auto" używa języka wyświetlania VS Code.',
  ...
  "settings.aboutGGAI.legacyMigration.title": "Migracja starszej wersji",
  "settings.aboutGGAI.legacyMigration.description":
    "Migruj ustawienia z poprzedniej instalacji GG.AI Code, w tym klucze API dostawców i domyślny model.",
  "migration.welcome.title": "Witamy w nowym GG.AI Code",
  "migration.welcome.detected": "Wykryliśmy ustawienia z poprzedniej instalacji GG.AI Code.",
  ...
  "migration.steps.subtitle":
    "Znaleźliśmy ustawienia z poprzedniej instalacji GG.AI Code. Wybierz, co chcesz przenieść.",
