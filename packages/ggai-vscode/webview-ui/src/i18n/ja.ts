export const dict = {
  ...
  "provider.connect.opencodeZen.line1":
    "GG.AI Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: GG.AIはまだMCP認証をサポートしていません。',
  ...
  "deviceAuth.title": "GG.AI Codeにサインイン",
  ...
  "profile.action.login": "GG.AI Codeでログイン",
  ...
  "settings.aboutGGAI.title": "GG.AI Codeについて",

  "session.messages.empty": "下にメッセージを入力して会話を始めましょう。",
  "session.messages.welcome":
    "GG.AI CodeはAIコーディングアシスタントです。機能の構築、バグの修正、コードベースの説明を依頼できます。",
  ...
  "settings.aboutGGAI.status.connected": "接続済み",
  "settings.aboutGGAI.status.connecting": "接続中...",
  "settings.aboutGGAI.status.disconnected": "切断",
  "settings.aboutGGAI.status.error": "エラー",
  "settings.aboutGGAI.cliServer": "CLIサーバー",
  "settings.aboutGGAI.status.label": "ステータス：",
  "settings.aboutGGAI.port.label": "ポート：",
  "settings.aboutGGAI.versionInfo": "バージョン情報",
  "settings.aboutGGAI.version.label": "バージョン：",
  "settings.aboutGGAI.extensionName": "GG.AI Code拡張機能",
  "settings.aboutGGAI.community": "コミュニティとサポート",
  "settings.aboutGGAI.feedback.prefix": "ご質問やフィードバックがありましたら、お気軽にissueを作成してください",
  "settings.aboutGGAI.feedback.or": "または",
  "settings.aboutGGAI.support.prefix":
    "請求やアカウントに関するご質問は、カスタマーサポートまでお問い合わせください",
  "settings.aboutGGAI.resetSettings.title": "設定をリセット",
  "settings.aboutGGAI.resetSettings.description":
    "GG.AI Code拡張機能のすべての設定をデフォルト値にリセットします。CLIやバックエンドの設定には影響しません。",
  "settings.aboutGGAI.resetSettings.button": "すべての設定をリセット",
  ...
  "settings.language.description": "GG.AI Code UIの言語を選択します。「自動」はVS Codeの表示言語を使用します。",
  ...
  "settings.aboutGGAI.legacyMigration.title": "レガシー移行",
  "settings.aboutGGAI.legacyMigration.description":
    "プロバイダーのAPIキーやデフォルトモデルなど、以前にインストールしたGG.AI Codeから設定を移行します。",
  "migration.welcome.title": "新しいGG.AI Codeへようこそ",
  "migration.welcome.detected": "以前にインストールされたGG.AI Codeの設定を検出しました。",
  ...
  "migration.steps.subtitle": "以前のGG.AI Codeインストールの設定が見つかりました。引き継ぐ項目を選択してください。",
