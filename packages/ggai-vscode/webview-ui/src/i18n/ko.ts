...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "{{provider}} API 키를 입력하여 계정을 연결하고 GG.AI에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.opencodeZen.line1":
    "GG.AI Zen은 코딩 에이전트를 위해 최적화된 신뢰할 수 있는 엄선된 모델에 대한 액세스를 제공합니다.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "를 방문하여 인증 코드를 받아 계정을 연결하고 GG.AI에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "를 방문하고 아래 코드를 입력하여 계정을 연결하고 GG.AI에서 {{provider}} 모델을 사용하세요.",
  ...
  "dialog.server.description": "이 앱이 연결할 GG.AI 서버를 전환합니다.",
  ...
  "error.page.report.prefix": "이 오류를 GG.AI 팀에 제보해 주세요: ",
  ...
  "error.chain.mcpFailed": 'MCP 서버 "{{name}}" 실패. 참고: GG.AI는 아직 MCP 인증을 지원하지 않습니다.',
  ...
  "settings.general.row.appearance.description": "기기에서 GG.AI가 보이는 방식 사용자 지정",
  ...
  "settings.updates.toast.latest.description": "현재 최신 버전의 GG.AI를 사용 중입니다.",
  ...
  "deviceAuth.title": "GG.AI Code에 로그인",
  ...
  "profile.action.login": "GG.AI Code로 로그인",
  ...
  "settings.aboutGGAI.title": "GG.AI Code 정보",

  "session.messages.empty": "아래에 메시지를 입력하여 대화를 시작하세요.",
  "session.messages.welcome":
    "GG.AI Code는 AI 코딩 어시스턴트입니다. 기능 구축, 버그 수정 또는 코드베이스 설명을 요청하세요.",
  ...
  "settings.aboutGGAI.status.connected": "연결됨",
  "settings.aboutGGAI.status.connecting": "연결 중...",
  "settings.aboutGGAI.status.disconnected": "연결 끊김",
  "settings.aboutGGAI.status.error": "오류",
  "settings.aboutGGAI.cliServer": "CLI 서버",
  "settings.aboutGGAI.status.label": "상태:",
  "settings.aboutGGAI.port.label": "포트:",
  "settings.aboutGGAI.versionInfo": "버전 정보",
  "settings.aboutGGAI.version.label": "버전:",
  "settings.aboutGGAI.extensionName": "GG.AI Code 확장 프로그램",
  "settings.aboutGGAI.community": "커뮤니티 및 지원",
  "settings.aboutGGAI.feedback.prefix": "질문이나 피드백이 있으시면 다음에서 이슈를 열어주세요",
  "settings.aboutGGAI.feedback.or": "또는",
  "settings.aboutGGAI.support.prefix": "결제 또는 계정 관련 문의는 고객 지원팀에 문의하세요",
  "settings.aboutGGAI.resetSettings.title": "설정 초기화",
  "settings.aboutGGAI.resetSettings.description":
    "GG.AI Code 확장 프로그램의 모든 설정을 기본값으로 초기화합니다. CLI 또는 백엔드 구성에는 영향을 미치지 않습니다.",
  "settings.aboutGGAI.resetSettings.button": "모든 설정 초기화",
  ...
  "settings.language.description": 'GG.AI Code UI의 언어를 선택하세요. "자동"은 VS Code 표시 언어를 사용합니다.',
  ...
  "settings.aboutGGAI.legacyMigration.title": "레거시 마이그레이션",
  "settings.aboutGGAI.legacyMigration.description":
    "공급자 API 키 및 기본 모델을 포함하여 이전 GG.AI Code 설치에서 설정을 마이그레이션합니다.",
  "migration.welcome.title": "새로운 GG.AI Code에 오신 것을 환영합니다",
  "migration.welcome.detected": "이전 GG.AI Code 설치의 설정이 감지되었습니다.",
  ...
  "migration.steps.subtitle": "이전 GG.AI Code 설치에서 설정을 찾았습니다. 가져올 항목을 선택하세요.",
