export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Genesis Grid AI",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in GG.AI.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "GG.AI Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in GG.AI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in GG.AI.",
  ...
  "dialog.server.description": "Switch which GG.AI server this app connects to.",
  ...
  "toast.update.description": "A new version of GG.AI ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Genesis Grid AI team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, GG.AI does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "GG.AI includes free models so you can start immediately.",
  ...
  "settings.general.row.language.description": "Change the display language for GG.AI",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how GG.AI looks on your device",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how GG.AI is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when GG.AI launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of GG.AI.",
  ...
  "deviceAuth.title": "Sign in to GG.AI Code",
  ...
  "profile.action.login": "Login with GG.AI Code",
  ...
  "settings.aboutGGAI.title": "About GG.AI Code",

  "session.messages.empty": "Start a conversation by typing a message below.",
  "session.messages.welcome":
    "GG.AI Code is an AI coding assistant. Ask it to build features, fix bugs, or explain your codebase.",
  ...
  "settings.aboutGGAI.status.connected": "Connected",
  "settings.aboutGGAI.status.connecting": "Connecting...",
  "settings.aboutGGAI.status.disconnected": "Disconnected",
  ...
  "settings.aboutGGAI.versionInfo": "Version Information",
  "settings.aboutGGAI.version.label": "Version:",
  "settings.aboutGGAI.extensionName": "GG.AI Code Extension",
  "settings.aboutGGAI.community": "Community & Support",
  "settings.aboutGGAI.feedback.prefix": "If you have any questions or feedback, feel free to open an issue on",
  "settings.aboutGGAI.feedback.or": "or",
  "settings.aboutGGAI.support.prefix": "For billing or account questions, contact Customer Support at",
  "settings.aboutGGAI.resetSettings.title": "Reset Settings",
  "settings.aboutGGAI.resetSettings.description":
    "Reset all GG.AI Code extension settings to their default values. This does not affect CLI or backend configuration.",
  "settings.aboutGGAI.resetSettings.button": "Reset All Settings",
  ...
  "settings.language.description":
    'Choose the language for the GG.AI Code UI. "Auto" uses your VS Code display language.',
  ...
  "settings.aboutGGAI.legacyMigration.description":
    "Migrate settings from a previous installation of GG.AI Code, including provider API keys and default model.",
  "migration.welcome.title": "Welcome to the New GG.AI Code",
  "migration.welcome.detected": "We detected settings from a previous installation of GG.AI Code.",
  ...
  "migration.steps.subtitle": "We found settings from your previous GG.AI Code installation. Choose what to bring over.",
