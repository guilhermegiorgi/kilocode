export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af GG.AI",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i GG.AI.",
  ...
  "provider.connect.opencodeZen.line1":
    "GG.AI Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i GG.AI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i GG.AI.",
  ...
  "dialog.server.description": "Skift hvilken GG.AI-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af GG.AI ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til GG.AI-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, GG.AI understøtter ikke MCP-godkendelse endnu.',
  ...
  "settings.general.row.language.description": "Ændr visningssproget for GG.AI",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan GG.AI ser ud på din enhed",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan GG.AI er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når GG.AI starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af GG.AI.",
  ...
  "deviceAuth.title": "Log ind på GG.AI Code",
  ...
  "profile.action.login": "Log ind med GG.AI Code",
  ...
  "session.messages.welcome":
    "GG.AI Code er en AI-kodningsassistent. Bed den om at bygge funktioner, rette fejl eller forklare din kodebase.",
  ...
  "settings.aboutGGAI.status.connected": "Forbundet",
  "settings.aboutGGAI.status.connecting": "Forbinder...",
  "settings.aboutGGAI.status.disconnected": "Afbrudt",
  "settings.aboutGGAI.status.error": "Fejl",
  "settings.aboutGGAI.cliServer": "CLI-server",
  "settings.aboutGGAI.status.label": "Status:",
  "settings.aboutGGAI.port.label": "Port:",
  "settings.aboutGGAI.versionInfo": "Versionsinformation",
  "settings.aboutGGAI.version.label": "Version:",
  "settings.aboutGGAI.extensionName": "GG.AI Code-udvidelse",
  "settings.aboutGGAI.community": "Fællesskab og support",
  "settings.aboutGGAI.feedback.prefix":
    "Hvis du har spørgsmål eller feedback, er du velkommen til at åbne en issue på",
  "settings.aboutGGAI.feedback.or": "eller",
  "settings.aboutGGAI.support.prefix": "For fakturerings- eller kontospørgsmål, kontakt kundesupport på",
  "settings.aboutGGAI.resetSettings.title": "Nulstil indstillinger",
  "settings.aboutGGAI.resetSettings.description":
    "Nulstil alle GG.AI Code-udvidelsesindstillinger til standardværdierne. Dette påvirker ikke CLI- eller backend-konfiguration.",
  "settings.aboutGGAI.resetSettings.button": "Nulstil alle indstillinger",
  ...
  "settings.language.description": 'Vælg sproget til GG.AI Code-brugerfladen. "Auto" bruger VS Codes visningssprog.',
  ...
  "settings.aboutGGAI.legacyMigration.title": "Legacy-migrering",
  "settings.aboutGGAI.legacyMigration.description":
    "Migrer indstillinger fra en tidligere installation af GG.AI Code, herunder udbyder API-nøgler og standardmodel.",
  "migration.welcome.title": "Velkommen til det nye GG.AI Code",
  "migration.welcome.detected": "Vi har fundet indstillinger fra en tidligere installation af GG.AI Code.",
  ...
  "migration.steps.subtitle":
    "Vi har fundet indstillinger fra din tidligere GG.AI Code-installation. Vælg, hvad der skal overføres.",
