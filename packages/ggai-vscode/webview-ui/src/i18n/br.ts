export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo GG.AI",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no GG.AI.",
  ...
  "provider.connect.opencodeZen.line1":
    "GG.AI Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no GG.AI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no GG.AI.",
  ...
  "dialog.server.description": "Trocar para qual servidor GG.AI este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do GG.AI ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do GG.AI",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: GG.AI ainda não suporta autenticação MCP.',
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do GG.AI",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o GG.AI aparece no seu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o GG.AI é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o GG.AI iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do GG.AI.",
  ...
  "deviceAuth.title": "Entrar no GG.AI Code",
  ...
  "profile.action.login": "Entrar com GG.AI Code",
  ...
  "settings.aboutGGAI.title": "Sobre o GG.AI Code",

  "session.messages.empty": "Inicie uma conversa digitando uma mensagem abaixo.",
  "session.messages.welcome":
    "GG.AI Code é um assistente de programação com IA. Peça para criar funcionalidades, corrigir bugs ou explicar sua base de código.",
  ...
  "settings.aboutGGAI.status.error": "Erro",
  "settings.aboutGGAI.cliServer": "Servidor CLI",
  "settings.aboutGGAI.status.label": "Status:",
  "settings.aboutGGAI.port.label": "Porta:",
  "settings.aboutGGAI.versionInfo": "Informações da Versão",
  "settings.aboutGGAI.version.label": "Versão:",
  "settings.aboutGGAI.extensionName": "Extensão GG.AI Code",
  "settings.aboutGGAI.community": "Comunidade e Suporte",
  "settings.aboutGGAI.feedback.prefix": "Se você tiver perguntas ou feedback, abra uma issue no",
  "settings.aboutGGAI.feedback.or": "ou",
  "settings.aboutGGAI.support.prefix":
    "Para questões de cobrança ou conta, entre em contato com o Suporte ao Cliente em",
  "settings.aboutGGAI.resetSettings.title": "Redefinir Configurações",
  "settings.aboutGGAI.resetSettings.description":
    "Redefinir todas as configurações da extensão GG.AI Code para os valores padrão. Isso não afeta a configuração do CLI ou do backend.",
  "settings.aboutGGAI.resetSettings.button": "Redefinir Todas as Configurações",
  ...
  "settings.language.description":
    'Escolha o idioma da interface do GG.AI Code. "Auto" usa o idioma de exibição do VS Code.',
  ...
  "settings.aboutGGAI.legacyMigration.title": "Migração Legada",
  "settings.aboutGGAI.legacyMigration.description":
    "Migre as configurações de uma instalação anterior do GG.AI Code, incluindo chaves de API de provedor e modelo padrão.",
  "migration.welcome.title": "Bem-vindo ao Novo GG.AI Code",
  "migration.welcome.detected": "Detectamos configurações de uma instalação anterior do GG.AI Code.",
  ...
  "migration.steps.subtitle":
    "Encontramos configurações da sua instalação anterior do GG.AI Code. Escolha o que trazer.",
