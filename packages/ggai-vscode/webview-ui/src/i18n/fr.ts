export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par GG.AI",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans GG.AI.",
  ...
  "provider.connect.opencodeZen.line1":
    "GG.AI Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans GG.AI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans GG.AI.",
  ...
  "dialog.server.description": "Changez le serveur GG.AI auquel cette application se connecte.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe GG.AI",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour GG.AI",
  ...
  "deviceAuth.title": "Se connecter à GG.AI Code",
  ...
  "profile.action.login": "Se connecter avec GG.AI Code",
  ...
  "settings.aboutGGAI.title": "À propos de GG.AI Code",

  "session.messages.empty": "Commencez une conversation en tapant un message ci-dessous.",
  "session.messages.welcome":
    "GG.AI Code est un assistant de programmation IA. Demandez-lui de créer des fonctionnalités, corriger des bugs ou expliquer votre code.",
  ...
  "settings.aboutGGAI.status.connected": "Connecté",
  "settings.aboutGGAI.status.connecting": "Connexion en cours...",
  "settings.aboutGGAI.status.disconnected": "Déconnecté",
  "settings.aboutGGAI.status.error": "Erreur",
  "settings.aboutGGAI.cliServer": "Serveur CLI",
  "settings.aboutGGAI.status.label": "Statut :",
  "settings.aboutGGAI.port.label": "Port :",
  "settings.aboutGGAI.versionInfo": "Informations de version",
  "settings.aboutGGAI.version.label": "Version :",
  "settings.aboutGGAI.extensionName": "Extension GG.AI Code",
  "settings.aboutGGAI.community": "Communauté et support",
  ...
  "settings.aboutGGAI.resetSettings.title": "Réinitialiser les paramètres",
  "settings.aboutGGAI.resetSettings.description":
    "Réinitialiser tous les paramètres de l'extension GG.AI Code à leurs valeurs par défaut. Cela n'affecte pas la configuration CLI ou backend.",
  "settings.aboutGGAI.resetSettings.button": "Réinitialiser tous les paramètres",
  ...
  "settings.language.description":
    "Choisissez la langue de l'interface de GG.AI Code. \"Auto\" utilise la langue d'affichage de VS Code.",
  ...
  "settings.aboutGGAI.legacyMigration.title": "Migration de l'ancienne version",
  "settings.aboutGGAI.legacyMigration.description":
    "Migrer les paramètres d'une précédente installation de GG.AI Code, y compris les clés d'API des fournisseurs et le modèle par défaut.",
  "migration.welcome.title": "Bienvenue dans le nouveau GG.AI Code",
  "migration.welcome.detected": "Nous avons détecté des paramètres d'une précédente installation de GG.AI Code.",
  ...
  "migration.steps.subtitle":
    "Nous avons trouvé des paramètres de votre précédente installation de GG.AI Code. Choisissez ce que vous souhaitez transférer.",
