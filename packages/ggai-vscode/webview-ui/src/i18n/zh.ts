...
export const dict = {
  ...
  "dialog.provider.opencode.note": "使用 GG.AI Zen 或 API 密钥连接",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 GG.AI 中使用 {{provider}} 模型。",
  ...
  "provider.connect.opencodeZen.line1": "GG.AI Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 GG.AI 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 GG.AI 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切换此应用连接的 GG.AI 服务器。",
  ...
  "error.page.report.prefix": "请将此错误报告给 GG.AI 团队",
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: GG.AI 暂不支持 MCP 认证。',
  ...
  "settings.general.row.language.description": "更改 GG.AI 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 GG.AI 在你的设备上的外观",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 GG.AI 的主题。",
  ...
  "settings.updates.row.startup.description": "在 GG.AI 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 GG.AI。",
  ...
  "deviceAuth.title": "登录 GG.AI Code",
  ...
  "profile.action.login": "使用 GG.AI Code 登录",
  ...
  "settings.aboutGGAI.title": "关于 GG.AI Code",

  "session.messages.empty": "在下方输入消息以开始对话。",
  "session.messages.welcome": "GG.AI Code 是一个 AI 编程助手。让它帮你构建功能、修复 bug 或解释代码库。",
  ...
  "settings.aboutGGAI.status.connected": "已连接",
  "settings.aboutGGAI.status.connecting": "连接中...",
  "settings.aboutGGAI.status.disconnected": "已断开",
  "settings.aboutGGAI.status.error": "错误",
  "settings.aboutGGAI.cliServer": "CLI 服务器",
  "settings.aboutGGAI.status.label": "状态：",
  "settings.aboutGGAI.port.label": "端口：",
  "settings.aboutGGAI.versionInfo": "版本信息",
  "settings.aboutGGAI.version.label": "版本：",
  "settings.aboutGGAI.extensionName": "GG.AI Code 扩展",
  "settings.aboutGGAI.community": "社区与支持",
  "settings.aboutGGAI.feedback.prefix": "如果您有任何问题或反馈，欢迎在以下平台提交 issue",
  "settings.aboutGGAI.feedback.or": "或",
  "settings.aboutGGAI.support.prefix": "如有账单或账户问题，请联系客户支持",
  "settings.aboutGGAI.resetSettings.title": "重置设置",
  "settings.aboutGGAI.resetSettings.description":
    "将所有 GG.AI Code 扩展设置重置为默认值。这不会影响 CLI 或后端配置。",
  "settings.aboutGGAI.resetSettings.button": "重置所有设置",
  ...
  "settings.language.description": '"自动"将使用 VS Code 的显示语言。选择 GG.AI Code 界面的语言。',
  ...
  "settings.aboutGGAI.legacyMigration.title": "旧版本迁移",
  "settings.aboutGGAI.legacyMigration.description":
    "从之前安装的 GG.AI Code 迁移设置，包括提供商 API 密钥和默认模型。",
  "migration.welcome.title": "欢迎使用全新 GG.AI Code",
  "migration.welcome.detected": "我们检测到了来自之前安装的 GG.AI Code 的设置。",
  ...
  "migration.steps.subtitle": "我们发现了您之前 GG.AI Code 安装的设置。请选择要引入的内容。",
