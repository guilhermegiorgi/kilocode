...
// Copy of @ggai/ui-core/theme/context.tsx with two changes:
...
import type { DesktopTheme } from "@ggai/ui-core/theme/types"
import { resolveThemeVariant, themeToCss } from "@ggai/ui-core/theme/resolve"
import { DEFAULT_THEMES } from "./default-themes"
import { createSimpleContext } from "@ggai/ui-core/context/helper"

export type ColorScheme = "light" | "dark" | "system"

const DEFAULT_THEME_ID = "kilo" // ggai_change: was "oc-1"
...
export const { use: useTheme, provider: ThemeProvider } = createSimpleContext({
  ...
  init: (props: { defaultTheme?: string }) => {
    const [store, setStore] = createStore({
      ...
      themeId: props.defaultTheme ?? DEFAULT_THEME_ID, // ggai_change: was "oc-1"
