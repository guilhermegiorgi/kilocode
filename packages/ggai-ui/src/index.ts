...
// visual style of the legacy GG.AI VS Code extension.
//
...
export { GGAI_THEMES, kiloTheme, kiloVscodeTheme } from "./theme/default-themes"

export type { DesktopTheme } from "@ggai/ui-core/theme/types"
