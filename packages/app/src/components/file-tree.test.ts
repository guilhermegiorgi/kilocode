...
beforeAll(async () => {
  ...
  mock.module("@ggai/ui-core/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@ggai/ui-core/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@ggai/ui-core/icon", () => ({ Icon: () => null }))
  mock.module("@ggai/ui-core/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
