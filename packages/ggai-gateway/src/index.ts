...
export { buildKiloHeaders, getEditorNameHeader, getFeatureHeader, DEFAULT_HEADERS } from "./headers.js" // ggai_change - added getFeatureHeader
...
// ============================================================================
// For TUI components and commands, import from "@ggai/gateway/tui"
...
export {
  ENV_GGAI_API_URL,
  DEFAULT_GGAI_API_URL,
  GGAI_API_BASE,
  GGAI_OPENROUTER_BASE,
  POLL_INTERVAL_MS,
  DEFAULT_MODEL,
  DEFAULT_FREE_MODEL,
  TOKEN_EXPIRATION_MS,
