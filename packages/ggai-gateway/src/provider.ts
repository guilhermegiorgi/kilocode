...
import { GGAI_API_BASE, ANONYMOUS_API_KEY } from "./api/constants.js"

/**
 * Create a GGAI provider instance
 *
 * This provider wraps the OpenRouter SDK with GGAI-specific configuration
...
export function createKilo(options: KiloProviderOptions = {}): SDK {
  ...
  // Determine base URL
  const baseApiUrl = getKiloUrlFromToken(options.baseURL ?? GGAI_API_BASE, apiKey ?? "")
  ...
  // Create OpenRouter provider with GGAI configuration
