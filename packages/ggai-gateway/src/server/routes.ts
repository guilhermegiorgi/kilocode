...
import { GGAI_API_BASE, HEADER_FEATURE } from "../api/constants.js"
 ...
 * @example
 * ```typescript
 * import { createKiloRoutes } from "@ggai/gateway"
  ...
  return new Hono()
    ...
    .post(
      ...
      async (c: any) => {
        ...
        const baseApiUrl = GGAI_API_BASE + "/api/"
    ...
    .get(
      ...
      async (c: any) => {
        try {
          ...
          const url = `${GGAI_API_BASE}/api/trpc/cliSessionsV2.list?${params.toString()}`
