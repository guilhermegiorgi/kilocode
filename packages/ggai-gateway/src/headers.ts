...
export const X_GGAICODE_FEATURE = HEADER_FEATURE

/**
 * Get feature header value from GGAICODE_FEATURE env var.
...
/**
 * Default headers for GGAI requests
 */
...
/**
 * Build GGAI-specific headers from metadata and options
 */
export function buildKiloHeaders(
  ...
  const headers: Record<string, string> = {
    ...
    ...(feature ? { [X_GGAICODE_FEATURE]: feature } : {}),
  }
  // ggai_change end
