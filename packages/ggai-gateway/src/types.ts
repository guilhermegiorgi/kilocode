// ggai_change - Kilo Gateway types
...
export interface KiloProviderOptions {
  ...
  /**
   * Base URL for the GGAI API
   * Can be overridden by GGAI_API_URL environment variable
   * @default "https://api.gg.ai"
   */
  baseURL?: string
