...
import { GGAI_API_BASE, GGAI_OPENROUTER_BASE, MODELS_FETCH_TIMEOUT_MS } from "./constants.js"
...
export async function fetchKiloModels(options?: {
  ...
  // Construct base URL
  const defaultBaseURL = organizationId ? `${GGAI_API_BASE}/api/organizations/${organizationId}` : GGAI_OPENROUTER_BASE
