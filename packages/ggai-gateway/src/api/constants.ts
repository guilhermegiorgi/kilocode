...
export const ENV_GGAI_API_URL = "GGAI_API_URL"

/** Default Kilo API URL */
export const DEFAULT_GGAI_API_URL = "https://api.gg.ai"

/** Base URL for Kilo API - can be overridden by GGAI_API_URL env var */
export const GGAI_API_BASE = process.env[ENV_GGAI_API_URL] || DEFAULT_GGAI_API_URL

/** Default base URL for OpenRouter-compatible endpoint */
export const GGAI_OPENROUTER_BASE = `${GGAI_API_BASE}/api/openrouter`
...
/**
 * Header constants for GGAI API requests
 */
...
export const ENV_FEATURE = "GGAICODE_FEATURE"
// ggai_change end
