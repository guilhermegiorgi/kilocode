...
This is the GG.AI documentation site. GG.AI is the leading open source agentic engineering platform.
...
Note that this site is served under gg.ai/docs so the `/docs` prefix **must** be present in every image path.
