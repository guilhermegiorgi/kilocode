...
Visit [app.gg.ai](https://app.gg.ai/) and sign in. This gives you access to:
...
1. Click "Try GG.AI for Free" in the Kilo panel
2. Sign in with OAuth at gg.ai
...
Run Kilo from [app.gg.ai/cloud](https://app.gg.ai/cloud) without needing your local machine. Great for:
...
3. Try Cloud Agents at [app.gg.ai](https://app.gg.ai/)
