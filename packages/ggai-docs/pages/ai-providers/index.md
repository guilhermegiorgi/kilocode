---
title: "AI Providers"
description: "Configure and connect different AI model providers to GG.AI"
---

# AI Providers

GG.AI supports a wide variety of AI providers, giving you flexibility in how you power your AI-assisted development workflow. Choose from cloud providers, local models, or AI gateways based on your needs.

## Getting Started

The fastest way to get started is with **GG.AI's built-in provider**, which requires no configuration. Simply sign in and start coding.
...
| --------------- | --------------------------------------------------- |
| Ease of use     | [GG.AI (built-in)](/docs/ai-providers/kilocode) |
...
- **New to GG.AI?** Start with the [GG.AI provider](/docs/ai-providers/kilocode) - no setup required
