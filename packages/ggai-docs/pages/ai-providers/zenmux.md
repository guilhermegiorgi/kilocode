...
3. **Configure in GG.AI:** Add your API key to GG.AI settings.
...
- Check the [GG.AI GitHub repository](https://github.com/genesisgrid/kilocode) for integration-specific issues
