...
GG.AI supports v0, Vercel's AI model provider that offers an OpenAI-compatible API. This allows you to use v0's models with GG.AI through the familiar OpenAI API interface.

## Prerequisites

To use v0 with GG.AI, you'll need:
...
Setting up v0 in GG.AI is straightforward:

1. In GG.AI settings (click the {% codicon name="gear" /%} icon):
...
<!-- <img src="/docs/img/providers/v0-setup.png" alt="v0 configuration in GG.AI settings" width="600" /> -->
