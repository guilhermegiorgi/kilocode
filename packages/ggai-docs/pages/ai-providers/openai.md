...
# Using OpenAI With GG.AI

GG.AI supports accessing models directly through the official OpenAI API.
...
3.  **Create a Key:** Click "Create new secret key". Give your key a descriptive name (e.g., "GG.AI").
