...
# Using SAP AI Core With GG.AI

GG.AI supports accessing models through SAP AI Core, a service in the SAP Business Technology Platform that lets you efficiently run AI scenarios in a standardized, scalable, and hyperscaler-agnostic manner.
...
To use SAP AI Core with GG.AI, you'll need to create a service key for your SAP AI Core service instance:
...
GG.AI applies the following filters when fetching models:
...
3. Configure GG.AI with your credentials
