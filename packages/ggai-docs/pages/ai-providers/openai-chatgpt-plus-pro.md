...
# Using ChatGPT Subscriptions With GG.AI
...
5. Back in GG.AI settings, pick a model from the dropdown.
6. Save.
...
- **You can't use arbitrary OpenAI API models.** This provider only exposes the models listed in GG.AI's Codex model catalog.
- **You can't export/migrate your sign-in state with settings export.** OAuth tokens are stored in VS Code SecretStorage, which isn't included in GG.AI's settings export.
