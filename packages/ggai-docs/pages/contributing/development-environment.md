...
{% callout type="info" %}
**New versions of the VS Code extension and CLI are being developed in [genesisgrid/kilocode](https://github.com/genesisgrid/kilocode)** (extension at `packages/kilo-vscode`, CLI at `packages/opencode`). For extension and CLI development, please head over to that repository.
{% /callout %}
...
1. **Fork and Clone the Repository**:
   - **Fork the Repository**:
     - Visit the [GG.AI GitHub repository](https://github.com/genesisgrid/kilocode)
...
2. This will open a new VSCode window with GG.AI loaded
...
GG.AI uses several types of tests to ensure quality:
...
- Check the Output panel in VSCode (View > Output) and select "GG.AI" from the dropdown
