...
Users aren't guided through GG.AI's modes or key features. The existing tab-based tutorial is easily dismissed, causing users to miss critical functionality.
...
├── Content: "Welcome to GGAI! Let's take a quick tour."
...
The "Set API Key" button is at the bottom of settings, making GG.AI setup hard to discover and complete.

**Improvements:**

- Move "Set API Key" button next to API key input field
- Rearrange layout for better flow
- Make GG.AI provider setup prominent
...
- Integration with GG.AI teams for company/repo-personalized onboarding
