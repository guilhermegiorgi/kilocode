...
**IDP-initiated logins are not currently supported.** Users must navigate to the [Kilo Web App](https://app.gg.ai) to log in. Logging in directly from your identity provider's dashboard is not supported at this time.
{% /callout %}
...
### 1. Open [Organization](https://app.gg.ai/organizations) Dashboard
