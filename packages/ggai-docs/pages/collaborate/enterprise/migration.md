---
title: "Migration"
description: "Migrate your team to GG.AI Enterprise"
---
...
1. **Create organization** at [app.gg.ai](https://app.gg.ai)
2. **Subscribe to Teams ($15/user/month)** or **Enterprise ([Contact Sales](https://gg.ai/contact-sales))**
...
2. **Install GG.AI extension** alongside Cursor initially
3. **Migrate projects gradually** starting with non-critical work
4. **Train team** on GG.AI features and workflows
...
2. **Install GG.AI** extension for team members
3. **Start with simple tasks** in GG.AI
4. **Compare results** and team satisfaction

**Phase 2: Gradual Transition (Week 3-4)**

1. **Use GG.AI** for new projects
...
- [ ] Install GG.AI extension across team
...
GG.AI uses a compatible rules system that supports Cursor and Windsurf patterns. Migrating your custom rules and configurations is straightforward and typically takes 5-10 minutes per project.
...
- **AGENTS.md**: Works identically in GG.AI (no conversion needed)
- **Global rules**: Recreate in `~/.kilocode/rules/*.md` directory

GG.AI also supports mode-specific rules (`.kilocode/rules-{mode}/`), which Cursor and Windsurf don't have. This allows different rules for different workflows (e.g., Code mode vs Debug mode).
...
- GG.AI extension installation and setup
...
Ready to make the switch? Contact our migration team at migrations@gg.ai to plan your transition to transparent AI coding.
