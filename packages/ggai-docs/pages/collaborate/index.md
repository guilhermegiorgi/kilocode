---
title: "Collaborate"
description: "Work together with GG.AI team features"
---

# {% $markdoc.frontmatter.title %}

{% callout type="generic" %}
GG.AI makes it easy to work together with your team. Share sessions, manage team settings, and track AI adoption across your organization.
{% /callout %}
...
- [**Sessions & Sharing**](/docs/collaborate/sessions-sharing) — Share and collaborate on GG.AI sessions
...
GG.AI's paid plans provide powerful team management features:
...
- **Enterprise ([Contact Sales](https://gg.ai/contact-sales))** — Model controls, audit logs, SSO, dedicated support
