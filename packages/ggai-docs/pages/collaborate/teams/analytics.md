...
This usage overview includes all of your usage of the Kilo Gateway provider. It does **NOT** include any usage made via the GG.AI extension to other, non-GG.AI providers. You can choose which API provider to use from the extension's main settings page.
{% /callout %}
