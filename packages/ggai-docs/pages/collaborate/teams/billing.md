...
GG.AI seats purchases of Teams or Enterprise are separate from Kilo credits.
...
Organization Owners can purchase Kilo credits on the [Organization dashboard](https://app.gg.ai).

Organization credits are purchased on behalf of all users in the organization. Every member of the organization can use the credits in the organization's balance with the GG.AI model provider.
...
Organization members can use organization credits by choosing the correct organization profile in the dropdown in the Profiles tab of the GG.AI extension.
...
In order to add Members to your GG.AI Organization, you must have seat(s) available for them.
...
Invoices for any payment on the GG.AI platform, for seats or credits, will be available in the Invoices tab.
