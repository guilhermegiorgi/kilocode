...
description: "Add and manage team members in GG.AI"
---
...
Members can use the GG.AI extension and see data on the team's usage in the [usage dashboard](/docs/collaborate/teams/analytics).
