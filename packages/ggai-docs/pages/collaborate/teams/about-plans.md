---
title: "About Plans"
description: "Overview of GG.AI plans and pricing"
---

# About Plans

GG.AI accelerates development with AI-driven code generation and task automation. You can use GG.AI as an open source extension in VS Code or JetBrains IDEs.
...
GG.AI's paid plans, Teams and Enterprise, are the solution for these organizations.

{% callout type="note" %}

Purchases of GG.AI's paid plans are separate from model provider credits.
...
**Cost:** [Contact Sales](https://gg.ai/contact-sales)
