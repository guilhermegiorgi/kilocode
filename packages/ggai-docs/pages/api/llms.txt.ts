...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    // Add header
    sections.push("# GG.AI Documentation")
    sections.push("")
    sections.push(
      "This file contains the complete documentation for GG.AI, the leading open source agentic engineering platform.",
    )
    sections.push("")
    const protocol = req.headers["x-forwarded-proto"] || "https"
    const host = req.headers.host || "gg.ai"
