...
const terminalContent = {
  installation: (
    <>
      <span className="terminal-comment"># Install GG.AI VS Code Extension</span>
      {"\n"}
  ...
  gateway: (
    <>
      ...
      {"\n"}
      <span className="terminal-prompt">$</span> export GGAI_API_KEY="YOUR_API_KEY"
      {"\n"}
      <span className="terminal-prompt">$</span> curl https://api.gg.ai/api/gateway/chat/completions \{"\n"}
      -H "Authorization: Bearer $GGAI_API_KEY" \{"\n"}
  ...
  firstTask: (
    <>
      <span className="terminal-comment"># Start a new task with GG.AI</span>
      {"\n"}
...
const categories = [
  {
    title: "Get Started",
    description: "Install GG.AI and get up and running in minutes",
  ...
  {
    title: "Code with AI",
    description: "Learn how to use GG.AI to write, edit, and understand code",
    href: "/code-with-ai",
    icon: (
      <svg className="category-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
  ...
  {
    title: "Contributing",
    description: "Help improve GG.AI and learn about its architecture",
    href: "/contributing",
    icon: (
      <svg className="category-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        <path
    ...
    <div className="homepage">
      ...
      <section className="hero">
        <div className="hero-content">
          <h1 className="hero-title">GG.AI Documentation</h1>
          <p className="hero-subtitle">
            Explore our guides and examples to build with GG.AI, the most popular open source coding agent.
          </p>
          <div className="hero-buttons">
            <Link href="/getting-started" className="btn btn-primary">
              Get started with GG.AI →
            </Link>
      ...
      <section className="terminal-section">
        <div className="terminal-intro">
          ...
          <p className="terminal-description">Get started quickly with common GG.AI commands</p>
        </div>
        ...
        <div className="footer-grid">
          <div className="footer-item">
            ...
            <div>
              ...
              <Link href="https://gg.ai/discord" className="footer-link">
                Join our Discord
              </Link>
            </div>
          </div>
          <div className="footer-item">
            ...
            <div>
              ...
              <Link href="https://github.com/genesisgrid/kilocode/releases" className="footer-link">
                Changelog
              </Link>
            </div>
          </div>
          <div className="footer-item">
            ...
            <div>
              ...
              <Link href="https://github.com/genesisgrid/kilocode/issues" className="footer-link">
                Report an issue
              </Link>
            </div>
          </div>
