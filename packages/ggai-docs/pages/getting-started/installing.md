---
title: "Installation"
description: "How to install GG.AI on your system"
---

# Installation

Get started with GG.AI by installing it on your preferred platform. Choose your development environment below:
...
{% callout type="info" %}
We're rebuilding GG.AI from the ground up on the new [Kilo CLI](https://github.com/genesisgrid/kilocode). The pre-release extension is available for users who want to try the latest architecture and provide feedback, and don't mind some missing features and rough edges.
{% /callout %}
...
For the full feature status, see the [feature parity tracking document](https://github.com/genesisgrid/kilocode/blob/main/packages/kilo-vscode/docs/opencode-migration-plan.md).
...
Report issues or provide feedback in the [genesisgrid/kilocode repository](https://github.com/genesisgrid/kilocode/issues).
...
For VS Code-compatible editors like VSCodium, Gitpod, Eclipse Theia, and Windsurf, you can browse and install directly from the [GG.AI page on Open VSX Registry](https://open-vsx.org/extension/kilocode/Kilo-Code).
...
4. Search for "GG.AI"
5. Select "GG.AI" and click **Install**
...
1. **Download the VSIX file:**
   - Find official releases on the [GG.AI GitHub Releases page](https://github.com/genesisgrid/kilocode/releases)
   - Download the `.vsix` file from the [latest release](https://github.com/genesisgrid/kilocode/releases/latest)
...
{% image src="/docs/img/installing-vsix.png" alt="Installing GG.AI using VS Code's Install from VSIX dialog" width="600px" caption="Installing GG.AI using VS Code's \"Install from VSIX\" dialog" /%}
...
- Restart VS Code
- Verify GG.AI is listed and enabled in Extensions
- Try disabling and re-enabling the extension in Extensions
- Check Output panel for errors (View → Output, select "GG.AI")
...
- [Your First Task](/docs/code-with-ai/agents/chat-interface) - Learn the basics of working with GG.AI
...
- Submit issues on [GitHub](https://github.com/genesisgrid/kilocode/issues)
- Visit our [Reddit community](https://www.reddit.com/r/GGAI)
