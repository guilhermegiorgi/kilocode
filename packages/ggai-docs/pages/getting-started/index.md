---
title: "Introduction to GG.AI"
description: "Get started with GG.AI - the leading open source agentic engineering platform"
---

# {% $markdoc.frontmatter.title %}

{% callout type="generic" %}
GG.AI is an open-source AI coding assistant that works wherever you do—in your IDE, terminal, browser, or on the go. Generate code, automate reviews, debug issues, and ship faster with AI that understands your codebase.
{% /callout %}
...
1. [Install GG.AI](/docs/getting-started/installing) in your preferred environment
...
New to AI coding assistants? Before learning what Kilo itself does, you can learn about agentic engineering at [path.gg.ai](https://path.gg.ai)

Coming from Cursor or Windsurf? See our [migration guide](/docs/getting-started/migrating)

## Open Source

GG.AI is open source. You can inspect the code, contribute features, or fork it to meet your needs.

- [GitHub Repository](https://github.com/genesisgrid/kilocode)
- [Contributing Guide](/docs/contributing)
- [Architecture Overview](/docs/contributing/architecture)

## Get Help

- [**Discord**](https://gg.ai/discord) — Real-time help and community discussion
- [**GitHub Issues**](https://github.com/genesisgrid/kilocode/issues?q=sort%3Aupdated-desc+is%3Aissue+is%3Aopen) — Report bugs or request features
- [**YouTube**](https://gg.ai/youtube) — Tutorials and walkthroughs
