---
title: "Known Issues"
description: "Known issues and limitations of GG.AI."
tocDepth: 2
---

# Known Issues

This section contains known issues and limitations of GG.AI.
...
### GG.AI not visible (JCEF errors)

#### Symptoms

- GG.AI panel doesn't render or appears blank
...
GG.AI depends on **JCEF (JetBrains Chromium Embedded Framework)** to display its interface. If the bundled Java runtime doesn't include JCEF, or JCEF is disabled, the panel cannot render.
...
The IDE cannot validate the TLS certificate used by the GG.AI endpoint or a network proxy. Common causes include untrusted root certificates, corporate proxies intercepting HTTPS traffic, or missing intermediate certificates.
