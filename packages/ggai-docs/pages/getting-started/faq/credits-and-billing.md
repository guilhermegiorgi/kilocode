...
description: "Questions about credits, billing, and pricing in GG.AI"
tocDepth: 2
---

# Credits and Billing

This section contains questions about credits, billing, and pricing in GG.AI.

## Credits

### Why am I seeing requests for "Codestral 2508"?

GG.AI uses Codestral 2508 (a model by Mistral AI) as the dedicated engine for our Autocomplete feature. It is optimized for speed and low latency, making it perfect for real-time code suggestions.
