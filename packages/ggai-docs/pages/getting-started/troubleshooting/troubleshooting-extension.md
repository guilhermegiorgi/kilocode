...
description: "How to capture console logs and report issues with GG.AI"
---
...
1. Make sure the **GG.AI panel is open** in your IDE (the debug target won't appear unless the webview is active)
...
4. Find the entry with `"title": "GG.AI"` and open the `devtoolsFrontendUrl` link
