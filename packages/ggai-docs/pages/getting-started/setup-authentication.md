...
description: "Configure GG.AI and connect to your AI providers"
---

# Setup & Authentication

When you install GG.AI, you'll be prompted to sign in or create a free account. This automatically configures everything you need to get started.

## Quick Start with Kilo Account

1. Click **"Try GG.AI for Free"** in the extension
2. Sign in with your Google account
3. Allow VS Code to open the authorization URL

{% image src="/docs/img/signupflow.gif" alt="Sign up and registration flow with GG.AI" /%}

That's it! You're ready to [start your first task](/docs/getting-started/quickstart).

{% callout type="tip" title="Bonus Credits" %}
[Add credits to your account](https://app.gg.ai/profile) and get $20 bonus credits, or sign up for [Kilo Pass](https://gg.ai/features/kilo-pass).
{% /callout %}

## Kilo Gateway API Key

If you're using the [Kilo AI Gateway](/docs/gateway/) outside of the GG.AI extension (for example, with the Vercel AI SDK or OpenAI SDK), you'll need an API key:

1. Go to [app.gg.ai](https://app.gg.ai)
...
If you prefer to use your own API key or existing subscription, GG.AI supports **over 30 providers**. Here are some popular options to get started:
...
These are just a few examples! GG.AI supports many more providers including Google Gemini, DeepSeek, Mistral, Ollama (for local models), AWS Bedrock, Google Vertex, and more. See the complete list at [AI Providers](/docs/ai-providers/).
{% /callout %}

### ChatGPT Plus/Pro Subscription

Already have a ChatGPT subscription? You can use it with GG.AI through the [OpenAI ChatGPT provider](/docs/ai-providers/openai-chatgpt-plus-pro)—no API key needed.
...
Reach out to our [support team](mailto:hi@gg.ai) or join our [Discord community](https://gg.ai/discord).
{% /callout %}
