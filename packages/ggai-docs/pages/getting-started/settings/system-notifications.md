...
description: "Configure native OS notifications for GG.AI"
---
...
GG.AI uses system notifications to inform you about:
...
GG.AI's system notifications work on all major operating systems with different underlying technologies:
...
No additional setup required. GG.AI uses macOS's built-in command to display notifications.
...
**How it works:** GG.AI first attempts to use `terminal-notifier` and automatically falls back to AppleScript if it's not installed.
