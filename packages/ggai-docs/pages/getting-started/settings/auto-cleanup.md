...
As you work with GG.AI, each task creates files containing conversation history, checkpoints, and other data. Over time, this accumulates and can consume significant disk space. Auto-Cleanup solves this by:
...
Access Auto-Cleanup settings through the GG.AI settings panel:
