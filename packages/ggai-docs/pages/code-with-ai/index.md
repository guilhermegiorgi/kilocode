---
title: "Code with AI"
description: "Learn how to code with AI using GG.AI across different platforms and interfaces"
---

# {% $markdoc.frontmatter.title %}

{% callout type="generic" %}
GG.AI is your AI pair programmer that works in your IDE, terminal, or browser. Generate code, refactor, debug, and ship faster with AI that understands your codebase and context.
{% /callout %}

## Getting Started

New to GG.AI? Start here to understand the core concepts:

- [**Install GG.AI**](/docs/getting-started/installing) — Get started in VS Code, JetBrains, CLI, or mobile
