...
This guide walks you through setting up Mistral's Codestral model for free autocomplete in GG.AI. Mistral offers a free tier that's perfect for getting started with AI-powered code completions.

## Video Walkthrough

{% youtube url="https://www.youtube.com/embed/0aqBbB8fPho" caption="Setting up Mistral for free autocomplete in GG.AI" /%}

## Step 1: Open GG.AI Settings

In VS Code, open the GG.AI panel and click the **Settings** icon (gear) in the top-right corner.

![Open GG.AI Settings](/docs/img/mistral-setup/01-open-kilo-code-settings.png)
...
{% callout type="note" %}
When creating an autocomplete profile, you don't need to select a specific model—GG.AI will automatically use the appropriate Codestral model optimized for code completions.
{% /callout %}
...
## Step 9: Paste API Key in GG.AI

Return to GG.AI settings and paste your API key into the **Mistral API Key** field.
