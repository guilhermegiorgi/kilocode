---
title: "Autocomplete"
description: "AI-powered code autocompletion in GG.AI"
---

# Autocomplete

GG.AI's autocomplete feature provides intelligent code suggestions and completions while you're typing, helping you write code faster and more efficiently. It offers both automatic and manual triggering options.
...
When enabled, GG.AI automatically shows inline suggestions when you pause typing. This provides a seamless coding experience where suggestions appear naturally as you work.
...
3. GG.AI analyzes the surrounding context
...
When enabled, GG.AI will suggest completions as you type in the chat input. Press Tab to accept suggestions.
...
GG.AI automatically selects a provider for autocomplete in the following priority order:

- **Mistral** (using `codestral-latest`)
- **GG.AI** (using `mistralai/codestral-2508`)
...
We recommend disabling rival autocompletes to optimize your experience with GG.AI. To disable GitHub Copilot autocomplete in VSCode, go to **Settings** and navigate to **GitHub** > **Copilot: Advanced** (or search for 'copilot').
