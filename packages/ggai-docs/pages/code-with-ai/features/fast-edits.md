---
title: "Fast Edits"
description: "Quick inline code edits with GG.AI"
---

# Fast Edits

{% callout type="info" title="Default Setting" %}
Fast Edits (using the "Enable editing through diffs" setting) is enabled by default in GG.AI. You typically don't need to change these settings unless you encounter specific issues or want to experiment with different diff strategies.
{% /callout %}

GG.AI offers an advanced setting to change how it edits files, using diffs (differences) instead of rewriting entire files. Enabling this feature provides significant benefits.
...
{% image src="/docs/img/fast-edits/fast-edits-5.png" alt="GG.AI settings showing Enable editing through diffs" width="500" /%}
...
{% image src="/docs/img/fast-edits/fast-edits-4.png" alt="GG.AI settings showing Enable editing through diffs checkbox and Match precision slider" width="500" /%}
