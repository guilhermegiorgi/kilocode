...
description: GG.AI now includes experimental support for voice input in the chat interface.
---
...
GG.AI now includes experimental support for voice input in the chat interface. This feature allows you to dictate your messages using speech-to-text (STT) technology powered by OpenAI's Whisper API.
...
Voice transcription uses OpenAI's Whisper API for speech recognition. You need an OpenAI API configuration in GG.AI:

1. Configure an OpenAI provider profile in GG.AI settings
