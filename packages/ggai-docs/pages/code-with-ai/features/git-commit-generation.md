...
Generate descriptive commit messages automatically based on your staged git changes. GG.AI analyzes your staged files and creates conventional commit messages that follow best practices.
...
2. In the VS Code Source Control panel, look for the `GG.AI` logo next to the commit message field)
...
- [Settings Management](/docs/getting-started/settings) - Manage all your GG.AI preferences
