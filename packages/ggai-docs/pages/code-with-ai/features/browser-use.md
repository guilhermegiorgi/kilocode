---
title: "Browser Use"
description: "Using GG.AI to interact with web browsers"
---

# Browser Use

GG.AI provides browser automation capabilities that let you interact with websites directly from your coding workflow. This feature supports testing web applications, automating browser tasks, and capturing screenshots without leaving your editor.
...
By default, GG.AI uses a built-in browser that:
...
1. Click the gear icon {% codicon name="gear" /%} in GG.AI
...
**Purpose**: Determines the resolution of the browser session GG.AI uses.
