---
title: "Code Actions"
description: "Quick code actions and refactoring with GG.AI"
---

# Code Actions

Code Actions are a powerful feature of VS Code that provide quick fixes, refactorings, and other code-related suggestions directly within the editor. GG.AI integrates with this system to offer AI-powered assistance for common coding tasks.
...
Clicking the lightbulb, right-clicking and selecting "GG.AI", or using the keyboard shortcut (`Ctrl+.` or `Cmd+.` on macOS, by default), displays a menu of available actions.

{% image src="/docs/img/code-actions/code-actions-1.png" alt="VS Code code actions in line with code" width="500" /%}

## GG.AI's Code Actions

GG.AI provides the following Code Actions:
...
- **Explain Code:** Asks GG.AI to explain the selected code.
- **Fix Code:** Asks GG.AI to fix problems in the selected code (available when diagnostics are present).
- **Improve Code:** Asks GG.AI to suggest improvements to the selected code.

### Add to Context Deep Dive

The **Add to Context** action is listed first in the Code Actions menu so you can quickly add code snippets to your conversation. When you use it, GG.AI includes the filename and line numbers along with the code.
...
There are three main ways to use GG.AI's Code Actions:
...
4.  **Choose an Action:** Select the desired GG.AI action from the menu.
5.  **Review and Approve:** GG.AI will propose a solution in the chat panel. Review the proposed changes and approve or reject them.
...
3.  **Choose "GG.AI":** Select the "GG.AI" option from the context menu. A submenu will appear with the available GG.AI actions.
...
3.  **Type a Command:** Type "GG.AI" to filter the commands, then choose the relevant code action (e.g., "GG.AI: Explain Code"). You can also type the start of the command, like "GG.AI: Explain", and select from the filtered list.
4.  **Review and Approve:** GG.AI will propose a solution in the chat panel. Review the proposed changes and approve or reject them.
...
1.  **Open the Prompts Tab:** Click the {% codicon name="notebook" /%} icon in the GG.AI top menu bar.
...
By using GG.AI's Code Actions, you can quickly get AI-powered assistance directly within your coding workflow. This can save you time and help you write better code.
