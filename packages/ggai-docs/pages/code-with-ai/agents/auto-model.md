...
Auto Model (`kilo/auto`) is a smart model routing system that automatically selects the optimal AI model based on the GG.AI mode you're using. It balances cost and capability so you get the best results without manual model switching.
...
Select `kilo/auto` from the model dropdown in the GG.AI chat interface. That's all you need to do.
{% /callout %}

1. Open GG.AI in VS Code or JetBrains
...
- **New GG.AI users** - Great defaults without needing to understand model differences
...
Auto Model is a new feature and we're actively improving it. We'd love to hear how it's working for you! Share feedback in our [Discord](https://discord.gg/kilocode) or [open an issue on GitHub](https://github.com/genesisgrid/kilocode/issues).
{% /callout %}

## Related

- [Model Selection Guide](/docs/code-with-ai/agents/model-selection) - General guidance on choosing models
- [Using Modes](/docs/code-with-ai/agents/using-modes) - Learn about different GG.AI modes
