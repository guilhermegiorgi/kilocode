---
title: "Using Modes"
description: "Understanding and using different modes in GG.AI"
---

# Using Modes

Modes in GG.AI are specialized personas that tailor the assistant's behavior to your current task. Each mode offers different capabilities, expertise, and access levels to help you accomplish specific goals.
...
{% youtube url="https://youtu.be/cS4vQfX528w" caption="Explaining the different modes in GG.AI" /%}
...
4. **Accept suggestions:** Click on mode switch suggestions that GG.AI offers when appropriate

   {% image src="/docs/img/modes/modes-2.png" alt="Accepting a mode switch suggestion from GG.AI" width="400" /%}
