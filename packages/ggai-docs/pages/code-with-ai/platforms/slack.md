---
title: "Slack"
description: "Using GG.AI in Slack"
---

# Kilo for Slack

Kilo for Slack brings the power of GG.AI directly into your Slack workspace. Ask questions about your repositories, request code implementations, or get help with issues—all without leaving Slack.
...
- You must have a **GG.AI account** with available credits
- Your **Git provider integration must be configured** via the [Integrations tab](https://app.gg.ai/integrations) so Kilo can access your repositories

To install Kilo for Slack, simply go to the integrations menu in the sidebar on https://app.gg.ai and set up the Slack integration.
...
3. **AI generates a response** — GG.AI's AI analyzes your request and provides helpful responses
...
- **GG.AI credits are used** when Kilo performs work (model usage, operations, etc.)
- Credit usage is similar to using GG.AI through other interfaces
...
- Kilo can only access repositories you've connected through the [Integrations](https://app.gg.ai/integrations) page
...
1. Go to your [Kilo Workspace](https://app.gg.ai/)
...
Verify your Git provider integration is configured correctly in the [Integrations tab](https://app.gg.ai/integrations).
