---
title: "Deploy"
description: "Deploy your applications with GG.AI"
---

# Deploy

Kilo Deploy lets you ship **Next.js** and **static sites** directly from GG.AI, with:

- **One-click deployment** from the GG.AI dashboard
...
2. Click **Configure** and follow the prompts to connect GitHub to GG.AI
...
- Navigate to your [Organization dashboard](https://app.gg.ai/organizations) or [Profile](https://app.gg.ai/profile)
