---
title: "Deploy & Secure"
description: "Deploy applications and manage security with GG.AI"
---

# {% $markdoc.frontmatter.title %}

{% callout type="generic" %}
Deploy your applications directly from GG.AI and manage security with AI-powered reviews and scans.
{% /callout %}
