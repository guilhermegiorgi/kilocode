...
```
X-GGAI-OrganizationId: your_org_id
```
...
1. Add your provider API key in the Kilo dashboard or through your GG.AI extension settings
...
| `X-GGAI-OrganizationId` | No                      | Organization context for org-scoped requests |
| `X-GGAI-TaskId`         | No                      | Task identifier for prompt cache keying      |
| `X-GGAI-Version`        | No                      | Client version string                        |
