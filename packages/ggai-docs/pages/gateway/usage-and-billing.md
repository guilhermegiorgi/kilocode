...
Your account balance is the difference between total credits purchased and total usage. Check your balance in the [Kilo dashboard](https://app.gg.ai).
...
```json
{
  "error": {
    ...
    "code": 402,
    "metadata": {
      "buyCreditsUrl": "https://app.gg.ai/credits"
    }
  }
}
```
