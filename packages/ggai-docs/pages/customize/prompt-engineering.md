...
Prompt engineering is the art of crafting effective instructions for AI models like GG.AI. Well-written prompts lead to better results, fewer errors, and a more efficient workflow.

## General Principles

- **Be Clear and Specific:** Clearly state what you want GG.AI to do. Avoid ambiguity.
  - **Bad:** Fix the code.
...
It's often helpful to guide GG.AI through a "think-then-do" process:

1.  **Analyze:** Ask GG.AI to analyze the current code, identify problems, or plan the approach.
2.  **Plan:** Have GG.AI outline the steps it will take to complete the task.
3.  **Execute:** Instruct GG.AI to implement the plan, one step at a time.
4.  **Review:** Carefully review the results of each step before proceeding.

## Using Custom Instructions

You can provide custom instructions to further tailor GG.AI's behavior. There are two types of custom instructions:
...
- Adjust GG.AI's tone or personality.

See the [Custom Instructions](/docs/customize/custom-instructions) section for more details.

## Handling Ambiguity

If your request is ambiguous or lacks sufficient detail, GG.AI might:
...
If GG.AI doesn't produce the desired results, you can provide feedback by:

- **Rejecting Actions:** Click the "Reject" button when GG.AI proposes an action you don't want.
- **Providing Explanations:** When rejecting, explain _why_ you're rejecting the action. This helps GG.AI learn from its mistakes.
...
By following these tips, you can write effective prompts that get the most out of GG.AI's capabilities.
