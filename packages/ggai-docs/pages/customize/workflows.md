---
title: "Workflows"
description: "Create automated workflows with GG.AI"
---

# Workflows

Workflows automate repetitive tasks by defining step-by-step instructions for GG.AI to execute. Invoke any workflow by typing `/[workflow-name.md]` in the chat.

{% image src="/docs/img/slash-commands/workflows.png" alt="Workflows tab in GG.AI" width="600" caption="Workflows tab in GG.AI" /%}
...
Now you can trigger this workflow by typing `/submit-pr.md` in the chat. GG.AI will:
