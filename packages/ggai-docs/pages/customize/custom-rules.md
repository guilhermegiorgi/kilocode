---
title: "Custom Rules"
description: "Define custom rules for GG.AI behavior"
---

# Custom Rules

Custom rules provide a powerful way to define project-specific and global behaviors and constraints for the GG.AI AI agent. With custom rules, you can ensure consistent formatting, restrict access to sensitive files, enforce coding standards, and customize the AI's behavior for your specific project needs or across all projects.
...
GG.AI supports two types of custom rules:
...
GG.AI provides a built-in interface for managing your custom rules without manually editing files in the `.kilocode/rules/` directories. To access the UI, click on the <Codicon name="law" /> icon in the **bottom right corner** of the GG.AI window.
...
{% image src="/docs/img/custom-rules/rules-ui.png" alt="Rules tab in GG.AI" width="400" /%}

The easiest way to create and manage rules is through the built-in UI:

1. Access the rules management interface from the GG.AI panel
...
Rules will be automatically applied to all future GG.AI interactions. Any new changes will be applied immediately.
...
{% image src="/docs/img/custom-rules/custom-rules.png" alt="GG.AI ignores request to read sensitive file" width="600" /%}
