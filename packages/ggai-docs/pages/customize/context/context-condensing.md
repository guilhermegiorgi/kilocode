...
GG.AI monitors your context usage and may suggest condensing when you approach the context window limit. You'll see a notification indicating that condensing is recommended.
...
1. **Analysis**: GG.AI analyzes the entire conversation history
...
- **When prompted**: When GG.AI suggests condensing due to context limits
...
- Important context can be reinforced after condensing by reminding GG.AI of key details
