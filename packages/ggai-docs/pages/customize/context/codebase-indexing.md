...
Codebase Indexing enables semantic code search across your entire project using AI embeddings. Instead of searching for exact text matches, it understands the _meaning_ of your queries, helping GG.AI find relevant code even when you don't know specific function names or file locations.
...
4. **Provides the [`codebase_search`](/docs/automate/tools/codebase-search) tool** to GG.AI for intelligent code discovery
...
- **Enhanced AI Understanding**: GG.AI can better comprehend and work with your codebase
...
3. If you don't see the icon, open GG.AI settings (<Codicon name="gear" />) and search for **Codebase Indexing**
...
Once indexed, GG.AI can use the [`codebase_search`](/docs/automate/tools/codebase-search) tool to find relevant code:
