---
title: "Customize"
description: "Make GG.AI work your way with custom modes, rules, instructions, and more"
---

# {% $markdoc.frontmatter.title %}

{% callout type="generic" %}
GG.AI is highly customizable. Tailor its behavior to match your workflow, team standards, and project requirements with custom modes, rules, instructions, and more.
{% /callout %}

## Customization

Configure how GG.AI behaves and responds:
...
1. **Start with Custom Instructions** — Set up instructions in the [Custom Instructions](/docs/customize/custom-instructions) section to guide GG.AI's behavior
