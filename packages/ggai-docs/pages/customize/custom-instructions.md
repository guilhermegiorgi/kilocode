...
description: "Provide custom instructions to guide GG.AI"
---

# Custom Instructions

Custom Instructions allow you to personalize how GG.AI behaves, providing specific guidance that shapes responses, coding style, and decision-making processes.
...
{% image src="/docs/img/custom-instructions/custom-instructions.png" alt="GG.AI Modes tab showing global custom instructions interface" width="600" caption="GG.AI Modes tab showing global custom instructions interface" /%}

1.  **Open Modes Tab:** Click the <Codicon name="notebook" /> icon in the GG.AI top menu bar
...
Mode-specific instructions can be set using the Modes Tab
    ...
    {% image src="/docs/img/custom-instructions/custom-instructions-3.png" alt="GG.AI Modes tab showing mode-specific custom instructions interface" width="600" caption="GG.AI Modes tab showing mode-specific custom instructions interface" /%}
    * **Open Tab:** Click the <Codicon name="notebook" /> icon in the GG.AI top menu bar
