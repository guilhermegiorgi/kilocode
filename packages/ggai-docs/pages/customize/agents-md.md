...
The GG.AI **memory bank** feature has been deprecated in favor of AGENTS.md.
...
AGENTS.md is an open standard for configuring AI agent behavior in software projects. It's a simple Markdown file placed at the root of your project that contains instructions for AI coding assistants. The standard is supported by multiple AI coding tools, including GG.AI, Cursor, and Windsurf.
...
When working in a subdirectory, GG.AI will load both the root AGENTS.md and any subdirectory AGENTS.md files, with subdirectory files taking precedence for conflicting instructions.

## File Protection

Both `AGENTS.md` and `AGENT.md` are **write-protected files** in GG.AI. This means:
...
## How AGENTS.md Works in GG.AI

### Loading Behavior

When you start a task in GG.AI:

1. GG.AI checks for `AGENTS.md` or `AGENT.md` at the project root
...
AGENTS.md works alongside GG.AI's other configuration systems:
...
| **[Custom Rules](/docs/customize/custom-rules)**               | Project | `.kilocode/rules/`        | GG.AI-specific rules and constraints  | 2           |
| **[AGENTS.md](/docs/customize/agents-md)**                     | Project | `AGENTS.md`               | Universal standard for any AI coding tool | 3           |
| **[Global Custom Rules](/docs/customize/custom-rules)**        | Global  | `~/.kilocode/rules/`      | Global GG.AI rules                    | 4           |
...
AGENTS.md support is **enabled by default** in GG.AI. To disable it, edit `settings.json`:
...
- **[Custom Rules](/docs/customize/custom-rules)** - GG.AI-specific rules with more control
