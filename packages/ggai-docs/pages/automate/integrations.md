---
title: "Integrations"
description: "Overview of GG.AI integrations"
---

# GG.AI Integrations

Kilo Integrations lets you connect your GitHub or GitLab account (soon Bitbucket) to enable advanced features inside GG.AI. Once connected, Kilo can access your repositories securely, enabling features like **Code Reviews**, **Cloud Agents**, and **Kilo Deploy**.
...
- **Connect GitHub or GitLab to GG.AI** in a few clicks
...
Go to your **Personal** or **Organization Dashboard**, and navigate to the [Integrations](https://app.gg.ai/integrations) tab.
...
1. Go to the **Integrations** page:
   - **Personal**: [app.gg.ai/integrations/gitlab](https://app.gg.ai/integrations/gitlab)
...
2. Create a new application:
   - **Name**: `GG.AI`
   - **Redirect URI**: `https://app.gg.ai/api/integrations/gitlab/callback`
...
- Run GG.AI in the cloud from any device
...
- Verify the redirect URI matches: `https://app.gg.ai/api/integrations/gitlab/callback`
