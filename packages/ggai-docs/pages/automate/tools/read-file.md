...
The `read_file` tool examines the contents of files in a project. It allows GG.AI to understand code, configuration files, and documentation to provide better assistance.
...
- When GG.AI needs to understand existing code structure
- When GG.AI needs to analyze configuration files
- When GG.AI needs to extract information from text files
- When GG.AI needs to see code before suggesting changes
...
- When asked to explain or improve code, GG.AI first reads the relevant files to understand the current implementation.
- When troubleshooting configuration issues, GG.AI reads config files to identify potential problems.
- When working with documentation, GG.AI reads existing docs to understand the current content before suggesting improvements.
