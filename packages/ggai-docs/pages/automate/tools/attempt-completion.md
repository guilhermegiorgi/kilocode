...
The `attempt_completion` tool signals that GG.AI believes a task is complete and presents results to the user. It provides a summary of what was accomplished, optionally includes a command to demonstrate the result, and supports continued refinement through user feedback.
...
- When GG.AI believes the user's task has been completed
...
- Provides a clear signal that GG.AI believes the task is complete
...
- Feedback is processed and returned to GG.AI for further refinements
...
- When creating a website, GG.AI presents the solution and uses `open index.html` to show the result. The user provides feedback, and GG.AI refines the design.
- When implementing a feature, GG.AI summarizes the changes and their impact. The user requests additional test coverage, and GG.AI continues the task.
- When fixing bugs, GG.AI explains what was fixed and how the solution addresses the GG.AIt cause. The user confirms the fix works.
- When setting up a development environment, GG.AI confirms all components are installed. The user requests additional configuration, and GG.AI continues.
- When creating a data processing script, GG.AI summarizes the functionality. The user suggests performance improvements, and GG.AI optimizes the code.
