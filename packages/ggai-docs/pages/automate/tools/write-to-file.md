...
- When GG.AI needs to create a new file from scratch
- When GG.AI needs to completely rewrite an existing file
...
- When creating a new project, GG.AI generates multiple files but lets you review each before committing changes.
- When setting up configuration files, GG.AI shows the proposed configuration in a diff view for approval.
- When generating documentation, GG.AI creates markdown files but lets you make final adjustments in the diff view.
- When developing a prototype, GG.AI shows complete source files in a diff view where you can fine-tune before saving.
