---
title: "Local Models"
description: "Run AI models locally with GG.AI"
---

# Using Local Models

GG.AI supports running language models locally on your own machine using [Ollama](https://ollama.com/) and [LM Studio](https://lmstudio.ai/). This offers several advantages:

- **Privacy:** Your code and data never leave your computer.
- **Offline Access:** You can use GG.AI even without an internet connection.
...
GG.AI currently supports two main local model providers:
...
- **"No connection could be made because the target machine actively refused it":** This usually means that the Ollama or LM Studio server isn't running, or is running on a different port/address than GG.AI is configured to use. Double-check the Base URL setting.
