---
title: "Automate"
description: "Automate your development workflows with GG.AI"
---

# {% $markdoc.frontmatter.title %}

{% callout type="generic" %}
Automate repetitive tasks, set up AI-powered code reviews, and extend GG.AI's capabilities with integrations and MCP servers.
{% /callout %}
...
Connect GG.AI to external tools and services:
...
- [**Using MCP in GG.AI**](/docs/automate/mcp/using-in-kilo-code) — Configuration guide
...
Connect GG.AI with your development tools:
...
Customize and extend GG.AI's capabilities:
