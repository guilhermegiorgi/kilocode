...
The Agent Manager is a dedicated control panel for running and supervising GG.AI agents as interactive CLI processes. It supports:
...
- Install/update the GG.AI CLI (latest) — see [CLI setup](/docs/code-with-ai/platforms/cli)
...
- Command Palette: “GG.AI: Open Agent Manager”
- Or use the title/menu entry if available in your GG.AI UI
...
To use the Agent Manager with all features enabled, switch to the GG.AI provider or sign in through the extension.
...
- Remote sessions not visible
  ...
  - If using BYOK, session syncing is not available — switch to GG.AI provider or sign in through the extension
