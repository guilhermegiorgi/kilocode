...
- **A platform integration must be configured:** Connect your GitHub or GitLab account via the [Integrations page](https://app.gg.ai/integrations) so that the Review Agent can access your repositories. See the [Integration setup guide](/docs/automate/integrations) for detailed instructions.
- **GG.AI credits:** The AI model uses credits when analyzing your code.
...
- **GG.AI credits are still used** when the agent performs model reasoning during a review.

## Getting Started

1. Go to the **Code Reviews** page in your [personal dashboard](https://app.gg.ai/profile) or [organization dashboard](https://app.gg.ai/organizations).
