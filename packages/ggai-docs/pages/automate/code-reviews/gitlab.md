...
1. Go to **Code Reviews**:
   - **Personal**: [app.gg.ai/code-reviews](https://app.gg.ai/code-reviews)
...
Review comments are posted by a **GG.AI Review Bot** — not by your personal GitLab account. This bot is created automatically as a Project Access Token on each project.
...
- **URL**: `https://app.gg.ai/api/webhooks/gitlab`
...
- Ensure you have sufficient GG.AI credits
