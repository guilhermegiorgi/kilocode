...
const contributingItems: DropdownItem[] = [
  { label: "Contributing Guide", href: "/contributing", description: "How to contribute to GG.AI" },
  {
    label: "Code of Conduct",
    href: "https://github.com/genesisgrid/kilocode?tab=coc-ov-file",
    description: "Our community guidelines",
  },
  { label: "GitHub Repository", href: "https://github.com/genesisgrid/", description: "View source and issues" },
  { label: "Discord Community", href: "https://gg.ai/discord", description: "Join our community" },
]
...
const helpItems: DropdownItem[] = [
  ...
  { label: "Support", href: "https://gg.ai/support", description: "Get help from the team" },
  {
    label: "Changelog",
    href: "https://github.com/genesisgrid/kilocode/releases",
    ...
    <header className="top-header">
      ...
      <div className="top-bar">
        ...
        <Link href="/" className="logo-link flex gap-2 items-center">
          ...
          <div>
            <span className="logo-text font-brand">GG.AI</span>
        ...
        <div className="right-actions">
          ...
          <ThemeToggle />
          <Link href="https://gg.ai/github" className="github-link desktop-nav">
            GitHub
          </Link>
          <Link href="https://app.gg.ai" className="signin-btn desktop-nav">
            Sign in
          </Link>
        </div>
      </div>
      ...
      <div className="announcement-banner">
        <p>
          We're <Link href="https://blog.gg.ai/p/kilo-cli">replatforming our extensions on the new Kilo CLI</Link>.
          Contribute to the new CLI and pre-release extensions at{" "}
          <Link href="https://github.com/genesisgrid/kilocode">genesisgrid/kilocode</Link>.
        </p>
      </div>
