GG.AI supports all JetBrains IDEs including IntelliJ IDEA, WebStorm, PyCharm, and more.

### Prerequisites

Before installing the GG.AI plugin, ensure you have:
...
2. Then, you can click the button below to install GG.AI directly from the JetBrains Marketplace:

[![Install GG.AI](https://img.shields.io/badge/Install%20Kilo%20Code-F8F674?style=for-the-badge)](https://plugins.jetbrains.com/plugin/28350-kilo-code)
