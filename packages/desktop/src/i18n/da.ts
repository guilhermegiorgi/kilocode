export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af GG.AI",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af GG.AI er blevet downloadet. Vil du installere den og genstarte?",
