export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of GG.AI",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of GG.AI has been downloaded, would you like to install it and relaunch?",
