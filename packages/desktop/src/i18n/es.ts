export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de GG.AI",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de GG.AI. ¿Quieres instalarla y reiniciar?",
