export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do GG.AI",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do GG.AI foi baixada. Você gostaria de instalá-la e reiniciar?",
