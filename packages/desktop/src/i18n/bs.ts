export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju GG.AI-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} GG.AI-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
