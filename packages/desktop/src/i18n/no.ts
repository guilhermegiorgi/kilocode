export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av GG.AI",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av GG.AI er lastet ned. Vil du installere den og starte på nytt?",
