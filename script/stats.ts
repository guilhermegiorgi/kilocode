...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/genesisgrid/kilocode/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for genesisgrid/kilocode...\n")
